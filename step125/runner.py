...
from step125.hook import AgentHook, AgentHookContext, AgentRunHookContext
from step125.llm import LLMResponse
from step125.provider import LLMProvider
from step125.tool import Tool, ToolRegistry, ToolResult
...
class AgentRunner:
    ...
    async def run(self, spec: AgentRunSpec) -> AgentRunResult:
        ...
        from step125.security.workspace_access import bind_workspace_scope, reset_workspace_scope
        from step125.tools.file_state import FileStates, bind_file_states, reset_file_states
    ...
    def _append_injected_messages(
        ...
        from step125.session.history_visibility import is_hidden_history_message
