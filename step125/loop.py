...
from step125.bus.events import InboundMessage, OutboundMessage, StreamDeltaEvent
from step125.bus.outbound_events import (
    RetryWaitEvent,
...
from step125.bus.progress import build_bus_progress_callback
from step125.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step125.autocompact import AutoCompact
from step125.command import CommandContext, CommandRouter, register_builtin_commands
from step125.consolidation import Consolidator
from step125.context import ContextBuilder, RequestContext
from step125.goal_state import (
    goal_state_runtime_lines,
    runner_wall_llm_timeout_s,
    sustained_goal_active,
)
from step125.hook import (
    AgentHook,
    AgentHookContext,
...
from step125.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step125.model_runtime import ModelRuntimeResolver
from step125.memory import MemoryStore
from step125.pairing import PairingStore
from step125.runtime_context import (
...
from step125.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step125.security.workspace_access import WorkspaceScopeResolver
from step125.session import Session, SessionManager
from step125.session import turn_continuation
from step125.session.history_visibility import HIDDEN_HISTORY_META
from step125.session.keys import UNIFIED_SESSION_KEY
from step125.subagent import SubagentManager
from step125.tool import ToolRegistry
from step125.context import ToolContext
from step125.loader import ToolLoader
from step125.tools.file_state import FileStateStore
from step125.tools.exec_session import ExecSessionManager
from step125.tools.cli_apps import build_cli_app_manager
from step125.helpers import image_placeholder_text, truncate_text
from step125.utils.cancellation import task_is_cancelling
from step125.utils.document import reference_non_image_attachments
...
class AgentLoop:
    ...
    def __init__(
        ...
        # step125：CLI 应用白名单管理器（从 config.cli_apps.apps 注册，缺省空）
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step125.providers.factory import make_provider
    ...
    async def _state_build(self, ctx: TurnContext) -> str:
        ...
        from step125.session.manager import replay_max_messages_for_context
        ...
        from step125.tools.message import MessageTool
