...
class ToolContext:
    ...
    agent_loop: Any = None  # step125：AgentLoop 引用（MyTool 自省）
    workspace_sandbox: Any | None = None  # step125（G9）：宿主 workspace 限制状态（WorkspaceSandboxStatus）
...
class ContextBuilder:
    ...
    def skills(self) -> Any:
        ...
        if self._skills is None:
            from step125.skills import SkillsLoader
    ...
    def build_system_prompt(
        ...
        step125：注入近期历史（# Recent History 段），按 session_key 过滤。
