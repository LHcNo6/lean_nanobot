...
from step99.bus.events import InboundMessage, OutboundMessage, StreamDeltaEvent
from step99.bus.outbound_events import (
    RetryWaitEvent,
...
from step99.bus.progress import build_bus_progress_callback
from step99.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step99.autocompact import AutoCompact
from step99.command import CommandContext, CommandRouter, register_builtin_commands
from step99.consolidation import Consolidator
from step99.context import ContextBuilder, RequestContext
from step99.goal_state import (
    goal_state_runtime_lines,
    runner_wall_llm_timeout_s,
    sustained_goal_active,
)
from step99.hook import (
    AgentHook,
    AgentHookContext,
...
from step99.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step99.model_runtime import ModelRuntimeResolver
from step99.memory import MemoryStore
from step99.pairing import PairingStore
from step99.runtime_context import (
...
from step99.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step99.security.workspace_access import WorkspaceScopeResolver
from step99.session import Session, SessionManager
from step99.session import turn_continuation
from step99.session.history_visibility import HIDDEN_HISTORY_META
from step99.session.keys import UNIFIED_SESSION_KEY
from step99.subagent import SubagentManager
from step99.tool import ToolRegistry
from step99.context import ToolContext
from step99.loader import ToolLoader
from step99.tools.file_state import FileStateStore
from step99.tools.exec_session import ExecSessionManager
from step99.helpers import image_placeholder_text, truncate_text
from step99.utils.cancellation import task_is_cancelling
from step99.utils.document import reference_non_image_attachments
...
class AgentLoop:
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step99.providers.factory import make_provider
    ...
    async def _state_build(self, ctx: TurnContext) -> str:
        ...
        from step99.session.manager import replay_max_messages_for_context
        ...
        from step99.tools.message import MessageTool
