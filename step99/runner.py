...
from step99.hook import AgentHook, AgentHookContext, AgentRunHookContext
from step99.llm import LLMResponse
from step99.provider import LLMProvider
from step99.tool import Tool, ToolRegistry, ToolResult
...
class AgentRunner:
    ...
    async def run(self, spec: AgentRunSpec) -> AgentRunResult:
        ...
        from step99.security.workspace_access import bind_workspace_scope, reset_workspace_scope
        from step99.tools.file_state import FileStates, bind_file_states, reset_file_states
    ...
    def _append_injected_messages(
        ...
        from step99.session.history_visibility import is_hidden_history_message
