...
from step99.context import ContextBuilder, ToolContext
...
from step99.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step99.session import Session, SessionManager
from step99.skills.loader import BUILTIN_SKILLS_DIR
from step99.tool import Tool, ToolRegistry, ToolResult
from step99.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step99.context import current_request_context
        from step99.security.workspace_access import current_workspace_scope
