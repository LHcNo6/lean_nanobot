...
from step56.bus.events import InboundMessage
from step56.context import ContextBuilder, ToolContext
...
from step56.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step56.session import Session, SessionManager
from step56.skills.loader import BUILTIN_SKILLS_DIR
from step56.tool import Tool, ToolRegistry, ToolResult
from step56.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step56.context import current_request_context
        from step56.security.workspace_access import current_workspace_scope
