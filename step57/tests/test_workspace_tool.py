...
from step57.bus.events import InboundMessage
from step57.context import ContextBuilder, ToolContext
...
from step57.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step57.session import Session, SessionManager
from step57.skills.loader import BUILTIN_SKILLS_DIR
from step57.tool import Tool, ToolRegistry, ToolResult
from step57.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step57.context import current_request_context
        from step57.security.workspace_access import current_workspace_scope
