...
from step54.bus.events import InboundMessage
from step54.context import ContextBuilder, ToolContext
...
from step54.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step54.session import Session, SessionManager
from step54.skills.loader import BUILTIN_SKILLS_DIR
from step54.tool import Tool, ToolRegistry, ToolResult
from step54.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step54.context import current_request_context
        from step54.security.workspace_access import current_workspace_scope
