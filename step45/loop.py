...
from step45.bus.outbound_events import (
    RetryWaitEvent,
    StreamEndEvent,
    StreamedResponseEvent,
    outbound_message_for_event,
)
from step45.bus.progress import build_bus_progress_callback
from step45.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step45.autocompact import AutoCompact
from step45.command import CommandContext, CommandRouter, register_builtin_commands
from step45.consolidation import Consolidator
from step45.context import ContextBuilder, RequestContext
...
from step45.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step45.memory import MemoryStore
from step45.pairing import PairingStore
...
from step45.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step45.security.workspace_access import WorkspaceScopeResolver
from step45.session import Session, SessionManager
from step45.session import turn_continuation
from step45.session.history_visibility import HIDDEN_HISTORY_META
from step45.session.keys import UNIFIED_SESSION_KEY
from step45.subagent import SubagentManager
from step45.tool import ToolRegistry
from step45.context import ToolContext
from step45.loader import ToolLoader
from step45.helpers import truncate_text
from step45.utils.cancellation import task_is_cancelling
...
class StateTraceEntry:
    """单个状态执行的追踪记录（step45 新增，对齐 nanobot）。
...
class TurnContext:
    ...
    # step45：状态执行追踪列表，每个状态执行后 append 一条 StateTraceEntry
...
class AgentLoop:
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step45.providers.factory import make_provider
    ...
    async def _process_message(
        ...
        *,
        ...
        while ctx.state != TurnState.DONE:
            ...
            # step45：记录状态开始时间（perf_counter 高精度计时）
            t0 = time.perf_counter()
            try:
                event = await handler(ctx)
            except Exception as exc:
                # step45：异常时记录 trace（error="exception"），保持现有 break 逻辑
    ...
    async def _state_build(self, ctx: TurnContext) -> str:
        ...
        from step45.session.manager import replay_max_messages_for_context
    ...
    async def _state_run(self, ctx: TurnContext) -> str:
        ...
        from step45.runner import AgentRunResult
