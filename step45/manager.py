...
from step45.bus.events import OutboundMessage, StreamDeltaEvent
...
from step45.channels.registry import (
    ...
    def _init_channels(self) -> None:
        ...
        for name in sorted(candidates):
            ...
            if name not in names:
                print(f"[manager] Channel '{name}' not found in step45.channels, skipping")
                continue
            try:
