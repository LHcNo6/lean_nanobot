...
from step45.security import network
from step45.security import workspace_policy as wp
...
from step45.security.workspace_policy import WorkspaceBoundaryError
