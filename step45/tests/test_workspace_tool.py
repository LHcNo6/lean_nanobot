...
from step45.bus.events import InboundMessage
from step45.context import ContextBuilder, ToolContext
from step45.llm import LLMResponse, ToolCallRequest
from step45.loop import AgentLoop
...
from step45.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step45.session import Session, SessionManager
from step45.skills.loader import BUILTIN_SKILLS_DIR
from step45.tool import Tool, ToolRegistry, ToolResult
from step45.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step45.context import current_request_context
        from step45.security.workspace_access import current_workspace_scope
