...
from step45.hook import AgentHook, AgentHookContext, AgentRunHookContext
from step45.llm import LLMResponse
from step45.provider import LLMProvider
from step45.tool import Tool, ToolRegistry
...
class AgentRunner:
    async def run(self, spec: AgentRunSpec) -> AgentRunResult:
        ...
        from step45.security.workspace_access import bind_workspace_scope, reset_workspace_scope
        from step45.tools.file_state import FileStates, bind_file_states, reset_file_states
    ...
    def _append_injected_messages(
        ...
        from step45.session.history_visibility import is_hidden_history_message
