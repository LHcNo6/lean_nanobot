...
from step50.bus.events import InboundMessage
from step50.context import ContextBuilder, ToolContext
from step50.llm import LLMResponse, ToolCallRequest
from step50.loop import AgentLoop
from step50.memory import MemoryStore
from step50.provider import LLMProvider
from step50.runner import AgentRunSpec, AgentRunner
from step50.security.workspace_access import (
...
from step50.tool import Tool, ToolRegistry, ToolResult
from step50.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step50.context import current_request_context
        from step50.security.workspace_access import current_workspace_scope
