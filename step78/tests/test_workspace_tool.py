...
from step78.context import ContextBuilder, ToolContext
...
from step78.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step78.session import Session, SessionManager
from step78.skills.loader import BUILTIN_SKILLS_DIR
from step78.tool import Tool, ToolRegistry, ToolResult
from step78.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step78.context import current_request_context
        from step78.security.workspace_access import current_workspace_scope
