...
from step78.hook import AgentHook, AgentHookContext, AgentRunHookContext
from step78.llm import LLMResponse
from step78.provider import LLMProvider
from step78.tool import Tool, ToolRegistry, ToolResult
...
class AgentRunner:
    ...
    async def run(self, spec: AgentRunSpec) -> AgentRunResult:
        ...
        from step78.security.workspace_access import bind_workspace_scope, reset_workspace_scope
        from step78.tools.file_state import FileStates, bind_file_states, reset_file_states
    ...
    def _append_injected_messages(
        ...
        from step78.session.history_visibility import is_hidden_history_message
