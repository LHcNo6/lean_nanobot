...
class AgentLoop:
    ...
    def __init__(self, bus, provider, registry, session_manager,
                 context_builder, memory, identity, replay_budget,
                 hooks=None):
        self.bus = bus
    ...
    def _get_or_create_queue(self, session_key):
    ...
    async def _drain_leftover(self, session_key):
    ...
    async def _state_restore(self, ctx):
    ...
    async def _state_build(self, ctx):
    ...
    async def run_dream(self, tools=None):
