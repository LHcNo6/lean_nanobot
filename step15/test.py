"""Tests for Step 15 — Consolidation + Dream + MemoryStore."""
...
from step15.consolidation import Consolidator, _consolidation_boundary
from step15.helpers import estimate_message_tokens, estimate_prompt_tokens
...
from step15.hook import AgentHook, AgentHookContext, AgentRunHookContext, CompositeHook
from step15.llm import LLMResponse, ToolCallRequest
from step15.loop import AgentLoop, StreamPublishingHook, TurnContext, TurnState
from step15.provider import LLMProvider
from step15.governance import ContextGovernanceConfig, ContextGovernor
from step15.runner import AgentRunSpec, AgentRunner
from step15.session import Session, SessionManager
from step15.tool import ToolRegistry, Tool
...
from step15.tool import ToolResult
...
class TestGovernanceHelpers(unittest.TestCase):
    def test_estimate_message_tokens(self):
        from step15.helpers import estimate_message_tokens as emt
    ...
    def test_find_legal_message_start(self):
        from step15.helpers import find_legal_message_start
        msgs = [
    ...
    def test_truncate_text(self):
        from step15.helpers import truncate_text
        result = truncate_text("hello world", 5)
        self.assertIn("truncated", result)
        self.assertLessEqual(len(result), 20)

    def test_ensure_nonempty_tool_result(self):
        from step15.helpers import ensure_nonempty_tool_result
