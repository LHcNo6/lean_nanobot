...
from step105.bus.events import InboundMessage
from step105.context import ContextBuilder, ToolContext
...
from step105.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step105.session import Session, SessionManager
from step105.skills.loader import BUILTIN_SKILLS_DIR
from step105.tool import Tool, ToolRegistry, ToolResult
from step105.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step105.context import current_request_context
        from step105.security.workspace_access import current_workspace_scope
