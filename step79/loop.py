...
from step79.bus import MessageBus
from step79.bus.events import InboundMessage, OutboundMessage, StreamDeltaEvent
from step79.bus.outbound_events import (
    RetryWaitEvent,
...
from step79.bus.progress import build_bus_progress_callback
from step79.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step79.autocompact import AutoCompact
from step79.command import CommandContext, CommandRouter, register_builtin_commands
from step79.consolidation import Consolidator
from step79.context import ContextBuilder, RequestContext
from step79.goal_state import (
    goal_state_runtime_lines,
    runner_wall_llm_timeout_s,
    sustained_goal_active,
)
from step79.hook import (
    AgentHook,
    AgentHookContext,
...
from step79.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step79.model_runtime import ModelRuntimeResolver
from step79.memory import MemoryStore
from step79.pairing import PairingStore
from step79.runtime_context import (
...
from step79.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step79.security.workspace_access import WorkspaceScopeResolver
from step79.session import Session, SessionManager
from step79.session import turn_continuation
from step79.session.history_visibility import HIDDEN_HISTORY_META
from step79.session.keys import UNIFIED_SESSION_KEY
from step79.subagent import SubagentManager
from step79.tool import ToolRegistry
from step79.context import ToolContext
from step79.loader import ToolLoader
from step79.tools.file_state import FileStateStore
from step79.tools.exec_session import ExecSessionManager
from step79.helpers import image_placeholder_text, truncate_text
from step79.utils.cancellation import task_is_cancelling
from step79.utils.document import reference_non_image_attachments
...
class AgentLoop:
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step79.providers.factory import make_provider
    ...
    async def _state_build(self, ctx: TurnContext) -> str:
        ...
        from step79.session.manager import replay_max_messages_for_context
        ...
        from step79.tools.message import MessageTool
