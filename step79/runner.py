...
from step79.hook import AgentHook, AgentHookContext, AgentRunHookContext
from step79.llm import LLMResponse
...
class AgentRunner:
    ...
    async def run(self, spec: AgentRunSpec) -> AgentRunResult:
        ...
        from step79.security.workspace_access import bind_workspace_scope, reset_workspace_scope
        from step79.tools.file_state import FileStates, bind_file_states, reset_file_states
    ...
    def _append_injected_messages(
        ...
        from step79.session.history_visibility import is_hidden_history_message
