...
from step79.bus.events import InboundMessage
from step79.context import ContextBuilder, ToolContext
...
from step79.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step79.session import Session, SessionManager
from step79.skills.loader import BUILTIN_SKILLS_DIR
from step79.tool import Tool, ToolRegistry, ToolResult
from step79.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step79.context import current_request_context
        from step79.security.workspace_access import current_workspace_scope
