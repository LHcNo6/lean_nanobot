...
from step34.bus.events import InboundMessage
from step34.context import ContextBuilder, ToolContext
...
from step34.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step34.session import Session, SessionManager
from step34.skills.loader import BUILTIN_SKILLS_DIR
from step34.tool import Tool, ToolRegistry, ToolResult
from step34.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step34.context import current_request_context
        from step34.security.workspace_access import current_workspace_scope
