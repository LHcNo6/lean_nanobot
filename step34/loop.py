...
from step34.bus.outbound_events import (
    RetryWaitEvent,
    StreamEndEvent,
    StreamedResponseEvent,
    outbound_message_for_event,
)
from step34.bus.progress import build_bus_progress_callback
from step34.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step34.autocompact import AutoCompact
from step34.command import CommandContext, CommandRouter, register_builtin_commands
from step34.consolidation import Consolidator
from step34.context import ContextBuilder, RequestContext
from step34.goal_state import goal_state_runtime_lines, sustained_goal_active
from step34.hook import (
    AgentHook,
    AgentHookContext,
    AgentTurnHookSpec,
    build_agent_turn_hook,
)
from step34.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step34.memory import MemoryStore
from step34.pairing import PairingStore
from step34.runtime_context import (
    RUNTIME_CONTEXT_HISTORY_META,
    RuntimeContextBlock,
    append_runtime_context,
    resolve_runtime_context,
)
from step34.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step34.security.workspace_access import WorkspaceScopeResolver
from step34.session import Session, SessionManager
from step34.session import turn_continuation
from step34.session.history_visibility import HIDDEN_HISTORY_META
from step34.session.keys import UNIFIED_SESSION_KEY
...
from step34.utils.cancellation import task_is_cancelling
...
class AgentLoop:
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step34.providers.factory import make_provider
    ...
    async def _state_build(self, ctx: TurnContext) -> str:
        ...
        from step34.session.manager import replay_max_messages_for_context
    ...
    async def _process_system_message(
        ...
        *,
        ...
        # _build_agent_spec 需要 workspace_scope（_build_initial_messages 内部
        # 也计算了 scope 但未返回，这里重新计算一次，开销可忽略）。
        scope = self.workspace_scopes.for_message(msg, session.metadata)
