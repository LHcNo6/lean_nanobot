...
from step34.hook import AgentHook, AgentHookContext, AgentRunHookContext
from step34.llm import LLMResponse
from step34.provider import LLMProvider
from step34.tool import Tool, ToolRegistry
...
class AgentRunner:
    async def run(self, spec: AgentRunSpec) -> AgentRunResult:
        ...
        from step34.security.workspace_access import bind_workspace_scope, reset_workspace_scope
    ...
    def _append_injected_messages(
        ...
        from step34.session.history_visibility import is_hidden_history_message
