...
from step53.bus.events import InboundMessage
from step53.context import ContextBuilder, ToolContext
from step53.llm import LLMResponse, ToolCallRequest
from step53.loop import AgentLoop
from step53.memory import MemoryStore
from step53.provider import LLMProvider
from step53.runner import AgentRunSpec, AgentRunner
from step53.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step53.session import Session, SessionManager
from step53.skills.loader import BUILTIN_SKILLS_DIR
from step53.tool import Tool, ToolRegistry, ToolResult
from step53.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step53.context import current_request_context
        from step53.security.workspace_access import current_workspace_scope
