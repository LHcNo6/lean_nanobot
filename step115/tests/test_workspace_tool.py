...
from step115.context import ContextBuilder, ToolContext
...
from step115.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step115.session import Session, SessionManager
from step115.skills.loader import BUILTIN_SKILLS_DIR
from step115.tool import Tool, ToolRegistry, ToolResult
from step115.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step115.context import current_request_context
        from step115.security.workspace_access import current_workspace_scope
