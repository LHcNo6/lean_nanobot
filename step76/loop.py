...
from step76.bus import MessageBus
from step76.bus.events import InboundMessage, OutboundMessage, StreamDeltaEvent
from step76.bus.outbound_events import (
    RetryWaitEvent,
...
from step76.bus.progress import build_bus_progress_callback
from step76.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step76.autocompact import AutoCompact
from step76.command import CommandContext, CommandRouter, register_builtin_commands
from step76.consolidation import Consolidator
from step76.context import ContextBuilder, RequestContext
from step76.goal_state import (
    goal_state_runtime_lines,
    runner_wall_llm_timeout_s,
    sustained_goal_active,
)
from step76.hook import (
    AgentHook,
    AgentHookContext,
...
from step76.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step76.model_runtime import ModelRuntimeResolver
from step76.memory import MemoryStore
from step76.pairing import PairingStore
from step76.runtime_context import (
...
from step76.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step76.security.workspace_access import WorkspaceScopeResolver
from step76.session import Session, SessionManager
from step76.session import turn_continuation
from step76.session.history_visibility import HIDDEN_HISTORY_META
from step76.session.keys import UNIFIED_SESSION_KEY
from step76.subagent import SubagentManager
from step76.tool import ToolRegistry
...
from step76.tools.exec_session import ExecSessionManager
from step76.helpers import image_placeholder_text, truncate_text
from step76.utils.cancellation import task_is_cancelling
from step76.utils.document import reference_non_image_attachments
...
class AgentLoop:
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step76.providers.factory import make_provider
    ...
    async def _state_build(self, ctx: TurnContext) -> str:
        ...
        from step76.session.manager import replay_max_messages_for_context
        ...
        from step76.tools.message import MessageTool
