...
from step76.bus.events import InboundMessage
from step76.context import ContextBuilder, ToolContext
...
from step76.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step76.session import Session, SessionManager
from step76.skills.loader import BUILTIN_SKILLS_DIR
from step76.tool import Tool, ToolRegistry, ToolResult
from step76.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step76.context import current_request_context
        from step76.security.workspace_access import current_workspace_scope
