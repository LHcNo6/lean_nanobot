...
class ProvidersConfig(Base):
    ...
    def convert_extra_providers(self) -> "ProvidersConfig":
        ...
        from step76.providers.registry import find_by_name
...
class MyToolConfig(Base):
    ...
    enable: bool = True
    allow_set: bool = False  # 内置文件工具默认开启
...
class Config(Base):
    ...
    def _match_provider(
        ...
        from step76.providers.registry import PROVIDERS, find_by_name, find_by_model
