...
from step100.bus.events import InboundMessage
from step100.context import ContextBuilder, ToolContext
...
from step100.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step100.session import Session, SessionManager
from step100.skills.loader import BUILTIN_SKILLS_DIR
from step100.tool import Tool, ToolRegistry, ToolResult
from step100.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step100.context import current_request_context
        from step100.security.workspace_access import current_workspace_scope
