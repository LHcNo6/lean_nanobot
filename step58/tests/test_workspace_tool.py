...
from step58.bus.events import InboundMessage
from step58.context import ContextBuilder, ToolContext
...
from step58.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step58.session import Session, SessionManager
from step58.skills.loader import BUILTIN_SKILLS_DIR
from step58.tool import Tool, ToolRegistry, ToolResult
from step58.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step58.context import current_request_context
        from step58.security.workspace_access import current_workspace_scope
