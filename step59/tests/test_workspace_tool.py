...
from step59.bus.events import InboundMessage
from step59.context import ContextBuilder, ToolContext
...
from step59.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step59.session import Session, SessionManager
from step59.skills.loader import BUILTIN_SKILLS_DIR
from step59.tool import Tool, ToolRegistry, ToolResult
from step59.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step59.context import current_request_context
        from step59.security.workspace_access import current_workspace_scope
