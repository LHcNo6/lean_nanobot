...
from step17a.helpers import (
    estimate_message_tokens,
    find_legal_message_start,
    truncate_text,
)
from step17a.llm import Runtime
from step17a.memory import MemoryStore, _ARCHIVE_SUMMARY_MAX_CHARS, _RAW_ARCHIVE_MAX_CHARS
    ...
    async def compact_idle_session(self, session_key: str, *, runtime: Runtime, max_suffix: int = 8) -> str:
        ...
        async with lock:
            ...
            if not messages_to_summarize:
                return ""
            from step17a.session import safe_filename
