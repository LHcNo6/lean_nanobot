...
from step101.bus.events import InboundMessage
from step101.context import ContextBuilder, ToolContext
...
from step101.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step101.session import Session, SessionManager
from step101.skills.loader import BUILTIN_SKILLS_DIR
from step101.tool import Tool, ToolRegistry, ToolResult
from step101.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step101.context import current_request_context
        from step101.security.workspace_access import current_workspace_scope
