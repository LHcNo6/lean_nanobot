...
from step101.helpers import find_legal_message_start, recent_message_start_index
...
class Session:
    ...
    def get_history(
        ...
        *,
        ...
        """
        from step101.helpers import estimate_message_tokens
        from step101.runtime_context import RUNTIME_CONTEXT_HISTORY_META, public_history_message
