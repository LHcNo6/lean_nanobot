...
from step82.bus.events import InboundMessage
from step82.context import ContextBuilder, ToolContext
...
from step82.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step82.session import Session, SessionManager
from step82.skills.loader import BUILTIN_SKILLS_DIR
from step82.tool import Tool, ToolRegistry, ToolResult
from step82.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step82.context import current_request_context
        from step82.security.workspace_access import current_workspace_scope
