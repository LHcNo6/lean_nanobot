...
from step75.bus.events import InboundMessage
from step75.context import ContextBuilder, ToolContext
...
from step75.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step75.session import Session, SessionManager
from step75.skills.loader import BUILTIN_SKILLS_DIR
from step75.tool import Tool, ToolRegistry, ToolResult
from step75.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step75.context import current_request_context
        from step75.security.workspace_access import current_workspace_scope
