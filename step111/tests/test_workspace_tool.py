...
from step111.context import ContextBuilder, ToolContext
...
from step111.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step111.session import Session, SessionManager
from step111.skills.loader import BUILTIN_SKILLS_DIR
from step111.tool import Tool, ToolRegistry, ToolResult
from step111.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step111.context import current_request_context
        from step111.security.workspace_access import current_workspace_scope
