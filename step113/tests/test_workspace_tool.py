...
from step113.bus.events import InboundMessage
from step113.context import ContextBuilder, ToolContext
...
from step113.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step113.session import Session, SessionManager
from step113.skills.loader import BUILTIN_SKILLS_DIR
from step113.tool import Tool, ToolRegistry, ToolResult
from step113.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step113.context import current_request_context
        from step113.security.workspace_access import current_workspace_scope
