...
from step32.bus.outbound_events import (
    RetryWaitEvent,
    StreamEndEvent,
    StreamedResponseEvent,
    outbound_message_for_event,
)
from step32.bus.progress import build_bus_progress_callback
from step32.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step32.autocompact import AutoCompact
from step32.command import CommandContext, CommandRouter, register_builtin_commands
from step32.consolidation import Consolidator
from step32.context import ContextBuilder, RequestContext
from step32.goal_state import goal_state_runtime_lines, sustained_goal_active
from step32.hook import (
    AgentHook,
    AgentHookContext,
    AgentTurnHookSpec,
    build_agent_turn_hook,
)
from step32.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step32.memory import MemoryStore
from step32.pairing import PairingStore
from step32.runtime_context import RuntimeContextBlock, resolve_runtime_context
from step32.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step32.security.workspace_access import WorkspaceScopeResolver
from step32.session import Session, SessionManager
from step32.session import turn_continuation
from step32.session.history_visibility import HIDDEN_HISTORY_META
from step32.session.keys import UNIFIED_SESSION_KEY
from step32.subagent import SubagentManager
from step32.tool import ToolRegistry
from step32.context import ToolContext
from step32.loader import ToolLoader
from step32.helpers import truncate_text
from step32.utils.cancellation import task_is_cancelling
...
class AgentLoop:
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step32.providers.factory import make_provider
