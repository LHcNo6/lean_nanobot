...
from step32.bus.events import InboundMessage
from step32.context import ContextBuilder, ToolContext
from step32.llm import LLMResponse, ToolCallRequest
from step32.loop import AgentLoop
...
from step32.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step32.session import Session, SessionManager
from step32.skills.loader import BUILTIN_SKILLS_DIR
from step32.tool import Tool, ToolRegistry, ToolResult
from step32.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step32.context import current_request_context
        from step32.security.workspace_access import current_workspace_scope
