...
from step84.tool import ToolRegistry, ToolResult
from step84.tools.filesystem import ReadFileTool
...
class TestReadFileDiscovery:
    ...
    def test_reexport_compatible(self) -> None:
        """旧导入路径仍可用（re-export）。"""
        from step84.tools.read_file import ReadFileTool as OldReadFileTool
        from step84.tools.filesystem import ReadFileTool as NewReadFileTool
