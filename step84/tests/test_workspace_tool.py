...
from step84.context import ContextBuilder, ToolContext
...
from step84.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step84.session import Session, SessionManager
from step84.skills.loader import BUILTIN_SKILLS_DIR
from step84.tool import Tool, ToolRegistry, ToolResult
from step84.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step84.context import current_request_context
        from step84.security.workspace_access import current_workspace_scope
