...
from step85.bus.events import InboundMessage
from step85.context import ContextBuilder, ToolContext
...
from step85.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step85.session import Session, SessionManager
from step85.skills.loader import BUILTIN_SKILLS_DIR
from step85.tool import Tool, ToolRegistry, ToolResult
from step85.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step85.context import current_request_context
        from step85.security.workspace_access import current_workspace_scope
