...
from step65.context import ContextBuilder, ToolContext
...
from step65.security.workspace_access import (
...
from step65.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step65.context import current_request_context
        from step65.security.workspace_access import current_workspace_scope
