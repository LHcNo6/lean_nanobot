...
from step65.bus.events import InboundMessage, OutboundMessage, StreamDeltaEvent
from step65.bus.outbound_events import (
    RetryWaitEvent,
...
from step65.bus.progress import build_bus_progress_callback
from step65.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step65.autocompact import AutoCompact
from step65.command import CommandContext, CommandRouter, register_builtin_commands
from step65.consolidation import Consolidator
from step65.context import ContextBuilder, RequestContext
from step65.goal_state import (
    goal_state_runtime_lines,
    runner_wall_llm_timeout_s,
    sustained_goal_active,
)
from step65.hook import (
    AgentHook,
    AgentHookContext,
...
from step65.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step65.model_runtime import ModelRuntimeResolver
from step65.memory import MemoryStore
from step65.pairing import PairingStore
from step65.runtime_context import (
...
from step65.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step65.security.workspace_access import WorkspaceScopeResolver
from step65.session import Session, SessionManager
from step65.session import turn_continuation
from step65.session.history_visibility import HIDDEN_HISTORY_META
from step65.session.keys import UNIFIED_SESSION_KEY
from step65.subagent import SubagentManager
from step65.tool import ToolRegistry
from step65.context import ToolContext
from step65.loader import ToolLoader
from step65.tools.file_state import FileStateStore
from step65.helpers import image_placeholder_text, truncate_text
from step65.utils.cancellation import task_is_cancelling
from step65.utils.document import reference_non_image_attachments
...
class AgentLoop:
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step65.providers.factory import make_provider
    ...
    async def _state_build(self, ctx: TurnContext) -> str:
        ...
        from step65.session.manager import replay_max_messages_for_context
        ...
        from step65.tools.message import MessageTool
