...
from step39.bus.events import InboundMessage
from step39.context import ContextBuilder, ToolContext
from step39.llm import LLMResponse, ToolCallRequest
from step39.loop import AgentLoop
...
from step39.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step39.session import Session, SessionManager
from step39.skills.loader import BUILTIN_SKILLS_DIR
from step39.tool import Tool, ToolRegistry, ToolResult
from step39.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step39.context import current_request_context
        from step39.security.workspace_access import current_workspace_scope
