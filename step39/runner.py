...
from step39.hook import AgentHook, AgentHookContext, AgentRunHookContext
from step39.llm import LLMResponse
from step39.provider import LLMProvider
from step39.tool import Tool, ToolRegistry
...
class AgentRunner:
    async def run(self, spec: AgentRunSpec) -> AgentRunResult:
        ...
        from step39.security.workspace_access import bind_workspace_scope, reset_workspace_scope
    ...
    def _append_injected_messages(
        ...
        from step39.session.history_visibility import is_hidden_history_message
