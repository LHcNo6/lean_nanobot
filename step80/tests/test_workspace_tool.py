...
from step80.bus.events import InboundMessage
from step80.context import ContextBuilder, ToolContext
...
from step80.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step80.session import Session, SessionManager
from step80.skills.loader import BUILTIN_SKILLS_DIR
from step80.tool import Tool, ToolRegistry, ToolResult
from step80.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step80.context import current_request_context
        from step80.security.workspace_access import current_workspace_scope
