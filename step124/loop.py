...
from step124.bus.events import InboundMessage, OutboundMessage, StreamDeltaEvent
from step124.bus.outbound_events import (
    RetryWaitEvent,
...
from step124.bus.progress import build_bus_progress_callback
from step124.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step124.autocompact import AutoCompact
from step124.command import CommandContext, CommandRouter, register_builtin_commands
from step124.consolidation import Consolidator
from step124.context import ContextBuilder, RequestContext
from step124.goal_state import (
    goal_state_runtime_lines,
    runner_wall_llm_timeout_s,
    sustained_goal_active,
)
from step124.hook import (
    AgentHook,
    AgentHookContext,
...
from step124.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step124.model_runtime import ModelRuntimeResolver
from step124.memory import MemoryStore
from step124.pairing import PairingStore
from step124.runtime_context import (
...
from step124.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step124.security.workspace_access import WorkspaceScopeResolver
from step124.session import Session, SessionManager
from step124.session import turn_continuation
from step124.session.history_visibility import HIDDEN_HISTORY_META
from step124.session.keys import UNIFIED_SESSION_KEY
...
from step124.helpers import image_placeholder_text, truncate_text
from step124.utils.cancellation import task_is_cancelling
from step124.utils.document import reference_non_image_attachments
...
class AgentLoop:
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step124.providers.factory import make_provider
    ...
    async def _state_build(self, ctx: TurnContext) -> str:
        ...
        from step124.session.manager import replay_max_messages_for_context
        ...
        from step124.tools.message import MessageTool
