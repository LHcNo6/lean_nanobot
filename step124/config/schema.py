...
class ModelPresetConfig(Base):
    ...
    def to_generation_settings(self) -> Any:
        from step124.llm import GenerationSettings
...
class ProvidersConfig(Base):
    ...
    def convert_extra_providers(self) -> "ProvidersConfig":
        ...
        from step124.providers.registry import find_by_name
...
class CliAppsConfig(Base):
    """cli_apps 配置段（step124，对齐 nanobot ``Config.cli_apps`` 最小形态）。"""
...
class Config(Base):
    ...
    cli_apps: CliAppsConfig = Field(default_factory=CliAppsConfig)  # step124
    ...
    def _match_provider(
        ...
        from step124.providers.registry import PROVIDERS, find_by_name, find_by_model
