...
from step66.bus import MessageBus
from step66.bus.events import InboundMessage, OutboundMessage, StreamDeltaEvent
from step66.bus.outbound_events import (
    RetryWaitEvent,
...
from step66.bus.progress import build_bus_progress_callback
from step66.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step66.autocompact import AutoCompact
from step66.command import CommandContext, CommandRouter, register_builtin_commands
from step66.consolidation import Consolidator
from step66.context import ContextBuilder, RequestContext
from step66.goal_state import (
    goal_state_runtime_lines,
    runner_wall_llm_timeout_s,
    sustained_goal_active,
)
from step66.hook import (
    AgentHook,
    AgentHookContext,
...
from step66.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step66.model_runtime import ModelRuntimeResolver
from step66.memory import MemoryStore
from step66.pairing import PairingStore
from step66.runtime_context import (
...
from step66.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step66.security.workspace_access import WorkspaceScopeResolver
from step66.session import Session, SessionManager
from step66.session import turn_continuation
from step66.session.history_visibility import HIDDEN_HISTORY_META
from step66.session.keys import UNIFIED_SESSION_KEY
from step66.subagent import SubagentManager
from step66.tool import ToolRegistry
from step66.context import ToolContext
from step66.loader import ToolLoader
from step66.tools.file_state import FileStateStore
from step66.helpers import image_placeholder_text, truncate_text
from step66.utils.cancellation import task_is_cancelling
from step66.utils.document import reference_non_image_attachments
...
class AgentLoop:
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step66.providers.factory import make_provider
    ...
    async def _state_build(self, ctx: TurnContext) -> str:
        ...
        from step66.session.manager import replay_max_messages_for_context
        ...
        from step66.tools.message import MessageTool
