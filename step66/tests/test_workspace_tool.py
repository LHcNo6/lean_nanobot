...
from step66.bus.events import InboundMessage
from step66.context import ContextBuilder, ToolContext
...
from step66.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step66.session import Session, SessionManager
from step66.skills.loader import BUILTIN_SKILLS_DIR
from step66.tool import Tool, ToolRegistry, ToolResult
from step66.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step66.context import current_request_context
        from step66.security.workspace_access import current_workspace_scope
