...
from step97.bus import MessageBus
from step97.bus.events import InboundMessage, OutboundMessage, StreamDeltaEvent
from step97.bus.outbound_events import (
    RetryWaitEvent,
...
from step97.bus.progress import build_bus_progress_callback
from step97.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step97.autocompact import AutoCompact
from step97.command import CommandContext, CommandRouter, register_builtin_commands
from step97.consolidation import Consolidator
from step97.context import ContextBuilder, RequestContext
from step97.goal_state import (
    goal_state_runtime_lines,
    runner_wall_llm_timeout_s,
    sustained_goal_active,
)
from step97.hook import (
    AgentHook,
    AgentHookContext,
...
from step97.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step97.model_runtime import ModelRuntimeResolver
from step97.memory import MemoryStore
from step97.pairing import PairingStore
from step97.runtime_context import (
...
from step97.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step97.security.workspace_access import WorkspaceScopeResolver
from step97.session import Session, SessionManager
from step97.session import turn_continuation
from step97.session.history_visibility import HIDDEN_HISTORY_META
from step97.session.keys import UNIFIED_SESSION_KEY
from step97.subagent import SubagentManager
from step97.tool import ToolRegistry
from step97.context import ToolContext
from step97.loader import ToolLoader
from step97.tools.file_state import FileStateStore
from step97.tools.exec_session import ExecSessionManager
from step97.helpers import image_placeholder_text, truncate_text
from step97.utils.cancellation import task_is_cancelling
from step97.utils.document import reference_non_image_attachments
...
class AgentLoop:
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step97.providers.factory import make_provider
    ...
    async def _state_build(self, ctx: TurnContext) -> str:
        ...
        from step97.session.manager import replay_max_messages_for_context
        ...
        from step97.tools.message import MessageTool
