...
from step97.bus.events import InboundMessage
from step97.context import ContextBuilder, ToolContext
...
from step97.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step97.session import Session, SessionManager
from step97.skills.loader import BUILTIN_SKILLS_DIR
from step97.tool import Tool, ToolRegistry, ToolResult
from step97.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step97.context import current_request_context
        from step97.security.workspace_access import current_workspace_scope
