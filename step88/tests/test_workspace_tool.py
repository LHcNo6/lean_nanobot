...
from step88.context import ContextBuilder, ToolContext
...
from step88.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step88.session import Session, SessionManager
from step88.skills.loader import BUILTIN_SKILLS_DIR
from step88.tool import Tool, ToolRegistry, ToolResult
from step88.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step88.context import current_request_context
        from step88.security.workspace_access import current_workspace_scope
