...
from step46.context import ContextBuilder, ToolContext
from step46.llm import LLMResponse, ToolCallRequest
from step46.loop import AgentLoop
...
from step46.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step46.session import Session, SessionManager
from step46.skills.loader import BUILTIN_SKILLS_DIR
from step46.tool import Tool, ToolRegistry, ToolResult
from step46.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step46.context import current_request_context
        from step46.security.workspace_access import current_workspace_scope
