...
from step36.config import load_config, resolve_config_env_vars
from step36.context import ContextBuilder
from step36.llm import LLMRuntime
...
from step36.providers.factory import build_provider_snapshot
from step36.session import SessionManager
...
async def main():
    ...
    async def _clock_runtime_context(request_context: Any):
        from step36.runtime_context import RuntimeContextBlock, wrap_runtime_context_lines
