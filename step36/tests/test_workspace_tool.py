...
from step36.bus.events import InboundMessage
from step36.context import ContextBuilder, ToolContext
...
from step36.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step36.session import Session, SessionManager
from step36.skills.loader import BUILTIN_SKILLS_DIR
from step36.tool import Tool, ToolRegistry, ToolResult
from step36.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step36.context import current_request_context
        from step36.security.workspace_access import current_workspace_scope
