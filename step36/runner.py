...
from step36.hook import AgentHook, AgentHookContext, AgentRunHookContext
from step36.llm import LLMResponse
from step36.provider import LLMProvider
from step36.tool import Tool, ToolRegistry
...
class AgentRunner:
    async def run(self, spec: AgentRunSpec) -> AgentRunResult:
        ...
        from step36.security.workspace_access import bind_workspace_scope, reset_workspace_scope
    ...
    def _append_injected_messages(
        ...
        from step36.session.history_visibility import is_hidden_history_message
