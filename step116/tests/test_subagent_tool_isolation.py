...
from step116.config.schema import Config, ToolsConfig
...
from step116.security.workspace_access import default_workspace_scope
from step116.subagent import SubagentManager, _flatten_tools_config
...
class TestSubagentRequestContextBinding(unittest.IsolatedAsyncioTestCase):
    """step116：子代理运行期 RequestContext / workspace_scope 绑定（契约 B1-B3）。"""
