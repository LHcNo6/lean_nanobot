...
from step116.context import ContextBuilder, ToolContext
...
from step116.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step116.session import Session, SessionManager
from step116.skills.loader import BUILTIN_SKILLS_DIR
from step116.tool import Tool, ToolRegistry, ToolResult
from step116.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step116.context import current_request_context
        from step116.security.workspace_access import current_workspace_scope
