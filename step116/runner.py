...
from step116.hook import AgentHook, AgentHookContext, AgentRunHookContext
from step116.llm import LLMResponse
from step116.provider import LLMProvider
from step116.tool import Tool, ToolRegistry, ToolResult
...
class AgentRunner:
    ...
    async def run(self, spec: AgentRunSpec) -> AgentRunResult:
        ...
        from step116.security.workspace_access import bind_workspace_scope, reset_workspace_scope
        from step116.tools.file_state import FileStates, bind_file_states, reset_file_states
    ...
    def _append_injected_messages(
        ...
        from step116.session.history_visibility import is_hidden_history_message
