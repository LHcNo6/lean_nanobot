...
class ProvidersConfig(Base):
    ...
    def convert_extra_providers(self) -> "ProvidersConfig":
        ...
        from step69.providers.registry import find_by_name
...
class ExecToolConfig(Base):
    """Shell exec 工具配置（step64：对齐 nanobot 最小形态）。"""
...
class Config(Base):
    ...
    def _match_provider(
        ...
        from step69.providers.registry import PROVIDERS, find_by_name, find_by_model
