...
from step69.bus.events import InboundMessage
from step69.context import ContextBuilder, ToolContext
...
from step69.skills.loader import BUILTIN_SKILLS_DIR
from step69.tool import Tool, ToolRegistry, ToolResult
from step69.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step69.context import current_request_context
        from step69.security.workspace_access import current_workspace_scope
