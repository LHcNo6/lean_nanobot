...
from step73.bus.events import InboundMessage
from step73.context import ContextBuilder, ToolContext
...
from step73.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step73.session import Session, SessionManager
from step73.skills.loader import BUILTIN_SKILLS_DIR
from step73.tool import Tool, ToolRegistry, ToolResult
from step73.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step73.context import current_request_context
        from step73.security.workspace_access import current_workspace_scope
