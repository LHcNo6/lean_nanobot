...
from step94.bus.events import InboundMessage
from step94.context import ContextBuilder, ToolContext
...
from step94.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step94.session import Session, SessionManager
from step94.skills.loader import BUILTIN_SKILLS_DIR
from step94.tool import Tool, ToolRegistry, ToolResult
from step94.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step94.context import current_request_context
        from step94.security.workspace_access import current_workspace_scope
