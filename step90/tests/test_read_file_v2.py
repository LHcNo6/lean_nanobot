...
from step90.tool import ToolRegistry, ToolResult
from step90.tools.filesystem import ReadFileTool
...
class TestReadFileDiscovery:
    ...
    def test_reexport_compatible(self) -> None:
        """旧导入路径仍可用（re-export）。"""
        from step90.tools.read_file import ReadFileTool as OldReadFileTool
        from step90.tools.filesystem import ReadFileTool as NewReadFileTool
