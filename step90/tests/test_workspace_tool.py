...
from step90.bus.events import InboundMessage
from step90.context import ContextBuilder, ToolContext
...
from step90.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step90.session import Session, SessionManager
from step90.skills.loader import BUILTIN_SKILLS_DIR
from step90.tool import Tool, ToolRegistry, ToolResult
from step90.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step90.context import current_request_context
        from step90.security.workspace_access import current_workspace_scope
