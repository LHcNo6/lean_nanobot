...
from step106.bus.events import InboundMessage
from step106.context import ContextBuilder, ToolContext
...
from step106.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step106.session import Session, SessionManager
from step106.skills.loader import BUILTIN_SKILLS_DIR
from step106.tool import Tool, ToolRegistry, ToolResult
from step106.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step106.context import current_request_context
        from step106.security.workspace_access import current_workspace_scope
