...
from step106.tool import ToolRegistry, ToolResult
from step106.tools.filesystem import ReadFileTool
...
class TestReadFileDiscovery:
    ...
    def test_reexport_compatible(self) -> None:
        """旧导入路径仍可用（re-export）。"""
        from step106.tools.read_file import ReadFileTool as OldReadFileTool
        from step106.tools.filesystem import ReadFileTool as NewReadFileTool
