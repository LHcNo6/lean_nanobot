...
from step70.bus.events import InboundMessage
from step70.context import ContextBuilder, ToolContext
...
from step70.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step70.session import Session, SessionManager
from step70.skills.loader import BUILTIN_SKILLS_DIR
from step70.tool import Tool, ToolRegistry, ToolResult
from step70.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step70.context import current_request_context
        from step70.security.workspace_access import current_workspace_scope
