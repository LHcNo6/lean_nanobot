...
from step47.config import load_config, resolve_config_env_vars
from step47.context import ContextBuilder
from step47.llm import LLMRuntime
...
from step47.providers.factory import build_provider_snapshot
from step47.session import SessionManager
...
async def main():
    ...
    async def _clock_runtime_context(request_context: Any):
        from step47.runtime_context import RuntimeContextBlock, wrap_runtime_context_lines
