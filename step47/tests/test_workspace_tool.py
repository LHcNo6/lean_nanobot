...
from step47.bus.events import InboundMessage
from step47.context import ContextBuilder, ToolContext
from step47.llm import LLMResponse, ToolCallRequest
from step47.loop import AgentLoop
from step47.memory import MemoryStore
from step47.provider import LLMProvider
from step47.runner import AgentRunSpec, AgentRunner
from step47.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step47.session import Session, SessionManager
from step47.skills.loader import BUILTIN_SKILLS_DIR
from step47.tool import Tool, ToolRegistry, ToolResult
from step47.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step47.context import current_request_context
        from step47.security.workspace_access import current_workspace_scope
