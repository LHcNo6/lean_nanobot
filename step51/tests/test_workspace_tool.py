...
from step51.bus.events import InboundMessage
from step51.context import ContextBuilder, ToolContext
from step51.llm import LLMResponse, ToolCallRequest
from step51.loop import AgentLoop
from step51.memory import MemoryStore
from step51.provider import LLMProvider
from step51.runner import AgentRunSpec, AgentRunner
from step51.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step51.session import Session, SessionManager
from step51.skills.loader import BUILTIN_SKILLS_DIR
from step51.tool import Tool, ToolRegistry, ToolResult
from step51.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step51.context import current_request_context
        from step51.security.workspace_access import current_workspace_scope
