...
from step51.bus.events import OutboundMessage, StreamDeltaEvent
...
from step51.channels.registry import (
    ...
    def _init_channels(self) -> None:
        ...
        for name in sorted(candidates):
            ...
            if name not in names:
                print(f"[manager] Channel '{name}' not found in step51.channels, skipping")
                continue
            try:
