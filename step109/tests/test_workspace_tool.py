...
from step109.bus.events import InboundMessage
from step109.context import ContextBuilder, ToolContext
...
from step109.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step109.session import Session, SessionManager
from step109.skills.loader import BUILTIN_SKILLS_DIR
from step109.tool import Tool, ToolRegistry, ToolResult
from step109.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step109.context import current_request_context
        from step109.security.workspace_access import current_workspace_scope
