...
from step121.context import ContextBuilder, ToolContext
...
from step121.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step121.session import Session, SessionManager
from step121.skills.loader import BUILTIN_SKILLS_DIR
from step121.tool import Tool, ToolRegistry, ToolResult
from step121.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step121.context import current_request_context
        from step121.security.workspace_access import current_workspace_scope
