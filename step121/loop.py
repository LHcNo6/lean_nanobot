...
from step121.bus import MessageBus
from step121.bus.events import InboundMessage, OutboundMessage, StreamDeltaEvent
from step121.bus.outbound_events import (
    RetryWaitEvent,
...
from step121.bus.progress import build_bus_progress_callback
from step121.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step121.autocompact import AutoCompact
from step121.command import CommandContext, CommandRouter, register_builtin_commands
from step121.consolidation import Consolidator
from step121.context import ContextBuilder, RequestContext
from step121.goal_state import (
    goal_state_runtime_lines,
    runner_wall_llm_timeout_s,
    sustained_goal_active,
)
from step121.hook import (
    AgentHook,
    AgentHookContext,
...
from step121.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step121.model_runtime import ModelRuntimeResolver
from step121.memory import MemoryStore
from step121.pairing import PairingStore
from step121.runtime_context import (
...
from step121.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step121.security.workspace_access import WorkspaceScopeResolver
from step121.session import Session, SessionManager
from step121.session import turn_continuation
from step121.session.history_visibility import HIDDEN_HISTORY_META
from step121.session.keys import UNIFIED_SESSION_KEY
from step121.subagent import SubagentManager
from step121.tool import ToolRegistry
from step121.context import ToolContext
from step121.loader import ToolLoader
from step121.tools.file_state import FileStateStore
from step121.tools.exec_session import ExecSessionManager
from step121.tools.cli_apps import build_cli_app_manager
from step121.helpers import image_placeholder_text, truncate_text
from step121.utils.cancellation import task_is_cancelling
from step121.utils.document import reference_non_image_attachments
...
class AgentLoop:
    ...
    def __init__(
        ...
        # step121：CLI 应用白名单管理器（从 config.cli_apps.apps 注册，缺省空）
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step121.providers.factory import make_provider
    ...
    async def _state_build(self, ctx: TurnContext) -> str:
        ...
        from step121.session.manager import replay_max_messages_for_context
        ...
        from step121.tools.message import MessageTool
