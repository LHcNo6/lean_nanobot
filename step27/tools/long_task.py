...
from step27.goal_state import GOAL_STATE_KEY, MAX_GOAL_OBJECTIVE_CHARS, parse_goal_state
from step27.schema import StringSchema, tool_parameters_schema
from step27.tool import Tool, ToolResult, tool_parameters
...
class CreateGoalTool(Tool):
    ...
    async def execute(self, objective: str = "", ui_summary: str | None = None, **kwargs: Any) -> ToolResult:
        from step27.context import current_request_context
