...
from step91.bus.events import InboundMessage
from step91.context import ContextBuilder, ToolContext
...
from step91.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step91.session import Session, SessionManager
from step91.skills.loader import BUILTIN_SKILLS_DIR
from step91.tool import Tool, ToolRegistry, ToolResult
from step91.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step91.context import current_request_context
        from step91.security.workspace_access import current_workspace_scope
