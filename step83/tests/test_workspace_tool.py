...
from step83.bus.events import InboundMessage
from step83.context import ContextBuilder, ToolContext
...
from step83.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step83.session import Session, SessionManager
from step83.skills.loader import BUILTIN_SKILLS_DIR
from step83.tool import Tool, ToolRegistry, ToolResult
from step83.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step83.context import current_request_context
        from step83.security.workspace_access import current_workspace_scope
