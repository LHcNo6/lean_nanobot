...
from step44.bus.events import InboundMessage
from step44.context import ContextBuilder, ToolContext
from step44.llm import LLMResponse, ToolCallRequest
from step44.loop import AgentLoop
...
from step44.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step44.session import Session, SessionManager
from step44.skills.loader import BUILTIN_SKILLS_DIR
from step44.tool import Tool, ToolRegistry, ToolResult
from step44.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step44.context import current_request_context
        from step44.security.workspace_access import current_workspace_scope
