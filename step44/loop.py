...
from step44.bus.outbound_events import (
    RetryWaitEvent,
    StreamEndEvent,
    StreamedResponseEvent,
    outbound_message_for_event,
)
from step44.bus.progress import build_bus_progress_callback
from step44.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step44.autocompact import AutoCompact
from step44.command import CommandContext, CommandRouter, register_builtin_commands
from step44.consolidation import Consolidator
from step44.context import ContextBuilder, RequestContext
...
from step44.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step44.memory import MemoryStore
from step44.pairing import PairingStore
from step44.runtime_context import (
    RUNTIME_CONTEXT_HISTORY_META,
    RuntimeContextBlock,
    append_runtime_context,
    resolve_runtime_context,
)
from step44.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step44.security.workspace_access import WorkspaceScopeResolver
from step44.session import Session, SessionManager
from step44.session import turn_continuation
from step44.session.history_visibility import HIDDEN_HISTORY_META
from step44.session.keys import UNIFIED_SESSION_KEY
from step44.subagent import SubagentManager
from step44.tool import ToolRegistry
from step44.context import ToolContext
from step44.loader import ToolLoader
from step44.helpers import truncate_text
from step44.utils.cancellation import task_is_cancelling
...
class TurnContext:
    ...
    # step44：状态执行追踪列表，每个状态执行后 append 一条 StateTraceEntry
...
class AgentLoop:
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step44.providers.factory import make_provider
    ...
    async def _process_message(
        ...
        *,
        ...
        while ctx.state != TurnState.DONE:
            ...
            # step44：记录状态开始时间（perf_counter 高精度计时）
            t0 = time.perf_counter()
            try:
                event = await handler(ctx)
            except Exception as exc:
                # step44：异常时记录 trace（error="exception"），保持现有 break 逻辑
    ...
    async def _state_build(self, ctx: TurnContext) -> str:
        ...
        from step44.session.manager import replay_max_messages_for_context
    ...
    async def _state_run(self, ctx: TurnContext) -> str:
        ...
        from step44.runner import AgentRunResult
