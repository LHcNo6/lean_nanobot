...
from step117.bus import MessageBus
from step117.bus.events import InboundMessage, OutboundMessage, StreamDeltaEvent
from step117.bus.outbound_events import (
    RetryWaitEvent,
...
from step117.bus.progress import build_bus_progress_callback
from step117.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step117.autocompact import AutoCompact
from step117.command import CommandContext, CommandRouter, register_builtin_commands
from step117.consolidation import Consolidator
from step117.context import ContextBuilder, RequestContext
from step117.goal_state import (
    goal_state_runtime_lines,
    runner_wall_llm_timeout_s,
    sustained_goal_active,
)
from step117.hook import (
    AgentHook,
    AgentHookContext,
...
from step117.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step117.model_runtime import ModelRuntimeResolver
from step117.memory import MemoryStore
from step117.pairing import PairingStore
from step117.runtime_context import (
...
from step117.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step117.security.workspace_access import WorkspaceScopeResolver
from step117.session import Session, SessionManager
from step117.session import turn_continuation
from step117.session.history_visibility import HIDDEN_HISTORY_META
from step117.session.keys import UNIFIED_SESSION_KEY
from step117.subagent import SubagentManager
from step117.tool import ToolRegistry
from step117.context import ToolContext
from step117.loader import ToolLoader
from step117.tools.file_state import FileStateStore
from step117.tools.exec_session import ExecSessionManager
from step117.tools.cli_apps import build_cli_app_manager
from step117.helpers import image_placeholder_text, truncate_text
from step117.utils.cancellation import task_is_cancelling
from step117.utils.document import reference_non_image_attachments
...
class AgentLoop:
    ...
    def __init__(
        ...
        # step117：CLI 应用白名单管理器（从 config.cli_apps.apps 注册，缺省空）
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step117.providers.factory import make_provider
    ...
    async def _state_build(self, ctx: TurnContext) -> str:
        ...
        from step117.session.manager import replay_max_messages_for_context
        ...
        from step117.tools.message import MessageTool
