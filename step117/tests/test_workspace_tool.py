...
from step117.context import ContextBuilder, ToolContext
...
from step117.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step117.session import Session, SessionManager
from step117.skills.loader import BUILTIN_SKILLS_DIR
from step117.tool import Tool, ToolRegistry, ToolResult
from step117.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step117.context import current_request_context
        from step117.security.workspace_access import current_workspace_scope
