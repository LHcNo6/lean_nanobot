...
from step87.bus import MessageBus
from step87.bus.events import InboundMessage, OutboundMessage, StreamDeltaEvent
from step87.bus.outbound_events import (
    RetryWaitEvent,
...
from step87.bus.progress import build_bus_progress_callback
from step87.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step87.autocompact import AutoCompact
from step87.command import CommandContext, CommandRouter, register_builtin_commands
from step87.consolidation import Consolidator
from step87.context import ContextBuilder, RequestContext
from step87.goal_state import (
    goal_state_runtime_lines,
    runner_wall_llm_timeout_s,
    sustained_goal_active,
)
from step87.hook import (
    AgentHook,
    AgentHookContext,
...
from step87.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step87.model_runtime import ModelRuntimeResolver
from step87.memory import MemoryStore
from step87.pairing import PairingStore
from step87.runtime_context import (
...
from step87.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step87.security.workspace_access import WorkspaceScopeResolver
from step87.session import Session, SessionManager
from step87.session import turn_continuation
from step87.session.history_visibility import HIDDEN_HISTORY_META
from step87.session.keys import UNIFIED_SESSION_KEY
from step87.subagent import SubagentManager
from step87.tool import ToolRegistry
from step87.context import ToolContext
from step87.loader import ToolLoader
from step87.tools.file_state import FileStateStore
from step87.tools.exec_session import ExecSessionManager
from step87.helpers import image_placeholder_text, truncate_text
from step87.utils.cancellation import task_is_cancelling
from step87.utils.document import reference_non_image_attachments
...
class AgentLoop:
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step87.providers.factory import make_provider
    ...
    async def _state_build(self, ctx: TurnContext) -> str:
        ...
        from step87.session.manager import replay_max_messages_for_context
        ...
        from step87.tools.message import MessageTool
