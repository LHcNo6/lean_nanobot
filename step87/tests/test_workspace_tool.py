...
from step87.bus.events import InboundMessage
from step87.context import ContextBuilder, ToolContext
...
from step87.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step87.session import Session, SessionManager
from step87.skills.loader import BUILTIN_SKILLS_DIR
from step87.tool import Tool, ToolRegistry, ToolResult
from step87.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step87.context import current_request_context
        from step87.security.workspace_access import current_workspace_scope
