...
class ToolContext:
    ...
    agent_loop: Any = None  # step93：AgentLoop 引用（MyTool 自省）
...
class ContextBuilder:
    ...
    def skills(self) -> Any:
        ...
        if self._skills is None:
            from step93.skills import SkillsLoader
    ...
    def build_system_prompt(
        ...
        step93：该参数不再是 no-op，为 True 时注入 MEMORY.md 长期记忆。
        ...
        # step93：长期记忆注入（MEMORY.md），对齐 nanobot get_memory_context()
