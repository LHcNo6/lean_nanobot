...
from step93.bus.events import InboundMessage
from step93.context import ContextBuilder, ToolContext
...
from step93.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step93.session import Session, SessionManager
from step93.skills.loader import BUILTIN_SKILLS_DIR
from step93.tool import Tool, ToolRegistry, ToolResult
from step93.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step93.context import current_request_context
        from step93.security.workspace_access import current_workspace_scope
