...
from step49.bus.events import InboundMessage
from step49.context import ContextBuilder, ToolContext
from step49.llm import LLMResponse, ToolCallRequest
from step49.loop import AgentLoop
from step49.memory import MemoryStore
from step49.provider import LLMProvider
from step49.runner import AgentRunSpec, AgentRunner
from step49.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step49.session import Session, SessionManager
from step49.skills.loader import BUILTIN_SKILLS_DIR
from step49.tool import Tool, ToolRegistry, ToolResult
from step49.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step49.context import current_request_context
        from step49.security.workspace_access import current_workspace_scope
