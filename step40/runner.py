...
from step40.hook import AgentHook, AgentHookContext, AgentRunHookContext
from step40.llm import LLMResponse
from step40.provider import LLMProvider
from step40.tool import Tool, ToolRegistry
...
class AgentRunner:
    async def run(self, spec: AgentRunSpec) -> AgentRunResult:
        ...
        from step40.security.workspace_access import bind_workspace_scope, reset_workspace_scope
        from step40.tools.file_state import FileStates, bind_file_states, reset_file_states
    ...
    def _append_injected_messages(
        ...
        from step40.session.history_visibility import is_hidden_history_message
