...
from step40.bus.events import InboundMessage
from step40.context import ContextBuilder, ToolContext
from step40.llm import LLMResponse, ToolCallRequest
from step40.loop import AgentLoop
...
from step40.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step40.session import Session, SessionManager
from step40.skills.loader import BUILTIN_SKILLS_DIR
from step40.tool import Tool, ToolRegistry, ToolResult
from step40.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step40.context import current_request_context
        from step40.security.workspace_access import current_workspace_scope
