...
from step40.security import network
from step40.security import workspace_policy as wp
...
from step40.security.workspace_policy import WorkspaceBoundaryError
