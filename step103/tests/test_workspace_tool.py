...
from step103.bus.events import InboundMessage
from step103.context import ContextBuilder, ToolContext
...
from step103.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step103.session import Session, SessionManager
from step103.skills.loader import BUILTIN_SKILLS_DIR
from step103.tool import Tool, ToolRegistry, ToolResult
from step103.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step103.context import current_request_context
        from step103.security.workspace_access import current_workspace_scope
