...
from step41.bus.outbound_events import (
    RetryWaitEvent,
    StreamEndEvent,
    StreamedResponseEvent,
    outbound_message_for_event,
)
from step41.bus.progress import build_bus_progress_callback
from step41.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step41.autocompact import AutoCompact
from step41.command import CommandContext, CommandRouter, register_builtin_commands
from step41.consolidation import Consolidator
from step41.context import ContextBuilder, RequestContext
...
from step41.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step41.memory import MemoryStore
from step41.pairing import PairingStore
from step41.runtime_context import (
    RUNTIME_CONTEXT_HISTORY_META,
    RuntimeContextBlock,
    append_runtime_context,
    resolve_runtime_context,
)
from step41.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step41.security.workspace_access import WorkspaceScopeResolver
from step41.session import Session, SessionManager
from step41.session import turn_continuation
from step41.session.history_visibility import HIDDEN_HISTORY_META
from step41.session.keys import UNIFIED_SESSION_KEY
from step41.subagent import SubagentManager
from step41.tool import ToolRegistry
from step41.context import ToolContext
from step41.loader import ToolLoader
from step41.helpers import truncate_text
from step41.utils.cancellation import task_is_cancelling
...
class AgentLoop:
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step41.providers.factory import make_provider
    ...
    async def _state_build(self, ctx: TurnContext) -> str:
        ...
        from step41.session.manager import replay_max_messages_for_context
    ...
    async def _state_run(self, ctx: TurnContext) -> str:
        ...
        from step41.runner import AgentRunResult
    ...
    async def _state_respond(self, ctx: TurnContext) -> str:
        ...
        # step41：ephemeral turn 挂载内部 _stop_reason（下划线前缀，与正常
        # stop_reason 区分），供 dream/heartbeat 等内部消费者判断停止原因。
