...
from step41.bus.events import InboundMessage
from step41.context import ContextBuilder, ToolContext
from step41.llm import LLMResponse, ToolCallRequest
from step41.loop import AgentLoop
...
from step41.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step41.session import Session, SessionManager
from step41.skills.loader import BUILTIN_SKILLS_DIR
from step41.tool import Tool, ToolRegistry, ToolResult
from step41.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step41.context import current_request_context
        from step41.security.workspace_access import current_workspace_scope
