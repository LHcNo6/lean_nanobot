...
from step62.bus.events import InboundMessage
from step62.context import ContextBuilder, ToolContext
...
from step62.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step62.session import Session, SessionManager
from step62.skills.loader import BUILTIN_SKILLS_DIR
from step62.tool import Tool, ToolRegistry, ToolResult
from step62.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step62.context import current_request_context
        from step62.security.workspace_access import current_workspace_scope
