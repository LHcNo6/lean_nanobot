...
from step74.bus.events import InboundMessage
from step74.context import ContextBuilder, ToolContext
...
from step74.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step74.session import Session, SessionManager
from step74.skills.loader import BUILTIN_SKILLS_DIR
from step74.tool import Tool, ToolRegistry, ToolResult
from step74.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step74.context import current_request_context
        from step74.security.workspace_access import current_workspace_scope
