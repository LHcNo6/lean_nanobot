...
from step86.bus.events import InboundMessage
from step86.context import ContextBuilder, ToolContext
...
from step86.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step86.session import Session, SessionManager
from step86.skills.loader import BUILTIN_SKILLS_DIR
from step86.tool import Tool, ToolRegistry, ToolResult
from step86.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step86.context import current_request_context
        from step86.security.workspace_access import current_workspace_scope
