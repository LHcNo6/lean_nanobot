...
from step86.bus import MessageBus
from step86.bus.events import InboundMessage, OutboundMessage, StreamDeltaEvent
from step86.bus.outbound_events import (
    RetryWaitEvent,
...
from step86.bus.progress import build_bus_progress_callback
from step86.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step86.autocompact import AutoCompact
from step86.command import CommandContext, CommandRouter, register_builtin_commands
from step86.consolidation import Consolidator
from step86.context import ContextBuilder, RequestContext
from step86.goal_state import (
    goal_state_runtime_lines,
    runner_wall_llm_timeout_s,
    sustained_goal_active,
)
from step86.hook import (
    AgentHook,
    AgentHookContext,
...
from step86.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step86.model_runtime import ModelRuntimeResolver
from step86.memory import MemoryStore
from step86.pairing import PairingStore
from step86.runtime_context import (
...
from step86.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step86.security.workspace_access import WorkspaceScopeResolver
from step86.session import Session, SessionManager
from step86.session import turn_continuation
from step86.session.history_visibility import HIDDEN_HISTORY_META
from step86.session.keys import UNIFIED_SESSION_KEY
from step86.subagent import SubagentManager
from step86.tool import ToolRegistry
from step86.context import ToolContext
from step86.loader import ToolLoader
from step86.tools.file_state import FileStateStore
from step86.tools.exec_session import ExecSessionManager
from step86.helpers import image_placeholder_text, truncate_text
from step86.utils.cancellation import task_is_cancelling
from step86.utils.document import reference_non_image_attachments
...
class AgentLoop:
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step86.providers.factory import make_provider
    ...
    async def _state_build(self, ctx: TurnContext) -> str:
        ...
        from step86.session.manager import replay_max_messages_for_context
        ...
        from step86.tools.message import MessageTool
