...
from step72.bus.events import InboundMessage
from step72.context import ContextBuilder, ToolContext
...
from step72.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step72.session import Session, SessionManager
from step72.skills.loader import BUILTIN_SKILLS_DIR
from step72.tool import Tool, ToolRegistry, ToolResult
from step72.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step72.context import current_request_context
        from step72.security.workspace_access import current_workspace_scope
