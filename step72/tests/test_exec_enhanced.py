...
from step72.tools.shell import ExecTool, _DEFAULT_DENY_PATTERNS
...
class TestPathManagement:
    ...
    def test_path_prepend_windows(self, monkeypatch) -> None:
        ...
        monkeypatch.setattr("step70.tools.shell._IS_WINDOWS", True)
    ...
    def test_path_prepend_unix(self, monkeypatch) -> None:
        ...
        monkeypatch.setattr("step70.tools.shell._IS_WINDOWS", False)
