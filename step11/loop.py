...
from step11.consolidation import Consolidator
from step11.context import ContextBuilder
from step11.events import InboundMessage, OutboundMessage
from step11.hook import AgentHook, CompositeHook
from step11.runner import AgentRunResult, AgentRunSpec, AgentRunner
from step11.session import Session, SessionManager
from step11.tool import ToolRegistry
...
class AgentLoop:
    ...
    async def _state_run(self, ctx: TurnContext) -> str:
        ...
        if self.hooks:
            hook = CompositeHook(self.hooks) if len(self.hooks) > 1 else self.hooks[0]
        spec = AgentRunSpec(
