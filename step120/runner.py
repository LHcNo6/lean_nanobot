...
from step120.hook import AgentHook, AgentHookContext, AgentRunHookContext
from step120.llm import LLMResponse
...
class AgentRunner:
    ...
    async def run(self, spec: AgentRunSpec) -> AgentRunResult:
        ...
        from step120.security.workspace_access import bind_workspace_scope, reset_workspace_scope
        from step120.tools.file_state import FileStates, bind_file_states, reset_file_states
    ...
    def _append_injected_messages(
        ...
        from step120.session.history_visibility import is_hidden_history_message
