...
from step120.context import ContextBuilder, ToolContext
...
from step120.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step120.session import Session, SessionManager
from step120.skills.loader import BUILTIN_SKILLS_DIR
from step120.tool import Tool, ToolRegistry, ToolResult
from step120.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step120.context import current_request_context
        from step120.security.workspace_access import current_workspace_scope
