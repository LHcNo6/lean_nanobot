...
from step120.bus.events import InboundMessage, OutboundMessage, StreamDeltaEvent
from step120.bus.outbound_events import (
    RetryWaitEvent,
...
from step120.bus.progress import build_bus_progress_callback
from step120.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step120.autocompact import AutoCompact
from step120.command import CommandContext, CommandRouter, register_builtin_commands
from step120.consolidation import Consolidator
from step120.context import ContextBuilder, RequestContext
from step120.goal_state import (
    goal_state_runtime_lines,
    runner_wall_llm_timeout_s,
    sustained_goal_active,
)
from step120.hook import (
    AgentHook,
    AgentHookContext,
...
from step120.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step120.model_runtime import ModelRuntimeResolver
from step120.memory import MemoryStore
from step120.pairing import PairingStore
from step120.runtime_context import (
...
from step120.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step120.security.workspace_access import WorkspaceScopeResolver
from step120.session import Session, SessionManager
from step120.session import turn_continuation
from step120.session.history_visibility import HIDDEN_HISTORY_META
from step120.session.keys import UNIFIED_SESSION_KEY
from step120.subagent import SubagentManager
from step120.tool import ToolRegistry
from step120.context import ToolContext
from step120.loader import ToolLoader
from step120.tools.file_state import FileStateStore
from step120.tools.exec_session import ExecSessionManager
from step120.tools.cli_apps import build_cli_app_manager
from step120.helpers import image_placeholder_text, truncate_text
from step120.utils.cancellation import task_is_cancelling
from step120.utils.document import reference_non_image_attachments
...
class AgentLoop:
    ...
    def __init__(
        ...
        # step120：CLI 应用白名单管理器（从 config.cli_apps.apps 注册，缺省空）
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step120.providers.factory import make_provider
    ...
    async def _state_build(self, ctx: TurnContext) -> str:
        ...
        from step120.session.manager import replay_max_messages_for_context
        ...
        from step120.tools.message import MessageTool
