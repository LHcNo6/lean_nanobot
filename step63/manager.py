...
from step63.bus.events import OutboundMessage, StreamDeltaEvent
...
from step63.channels.registry import (
    ...
    def _init_channels(self) -> None:
        ...
        for name in sorted(candidates):
            ...
            if name not in names:
                print(f"[manager] Channel '{name}' not found in step63.channels, skipping")
                continue
            try:
