...
from step63.bus.events import InboundMessage
from step63.context import ContextBuilder, ToolContext
...
from step63.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step63.session import Session, SessionManager
from step63.skills.loader import BUILTIN_SKILLS_DIR
from step63.tool import Tool, ToolRegistry, ToolResult
from step63.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step63.context import current_request_context
        from step63.security.workspace_access import current_workspace_scope
