...
from step60.security import network
from step60.security import workspace_policy as wp
...
from step60.security.workspace_policy import WorkspaceBoundaryError
