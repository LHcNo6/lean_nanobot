...
from step60.bus.events import InboundMessage
from step60.context import ContextBuilder, ToolContext
...
from step60.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step60.session import Session, SessionManager
from step60.skills.loader import BUILTIN_SKILLS_DIR
from step60.tool import Tool, ToolRegistry, ToolResult
from step60.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step60.context import current_request_context
        from step60.security.workspace_access import current_workspace_scope
