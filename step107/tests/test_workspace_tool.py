...
from step107.bus.events import InboundMessage
from step107.context import ContextBuilder, ToolContext
...
from step107.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step107.session import Session, SessionManager
from step107.skills.loader import BUILTIN_SKILLS_DIR
from step107.tool import Tool, ToolRegistry, ToolResult
from step107.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step107.context import current_request_context
        from step107.security.workspace_access import current_workspace_scope
