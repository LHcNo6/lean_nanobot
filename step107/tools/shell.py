...
from step107.security.workspace_access import current_tool_workspace
from step107.security.workspace_policy import is_path_within
from step107.tool import Tool, ToolResult, tool_parameters
from step107.tools.exec_session import (
...
from step107.tools.sandbox import wrap_command
...
class ExecTool(Tool):
    ...
    def __init__(
        ...
        self.sandbox = sandbox  # step89：沙箱后端名称
    ...
    async def execute(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            if self.sandbox and self.sandbox != "none":
                try:
                    exec_command = wrap_command(self.sandbox, command, self.working_dir or cwd, cwd)
