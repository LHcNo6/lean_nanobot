...
from step104.bus.events import InboundMessage
from step104.context import ContextBuilder, ToolContext
...
from step104.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step104.session import Session, SessionManager
from step104.skills.loader import BUILTIN_SKILLS_DIR
from step104.tool import Tool, ToolRegistry, ToolResult
from step104.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step104.context import current_request_context
        from step104.security.workspace_access import current_workspace_scope
