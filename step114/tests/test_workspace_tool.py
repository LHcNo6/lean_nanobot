...
from step114.context import ContextBuilder, ToolContext
...
from step114.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step114.session import Session, SessionManager
from step114.skills.loader import BUILTIN_SKILLS_DIR
from step114.tool import Tool, ToolRegistry, ToolResult
from step114.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step114.context import current_request_context
        from step114.security.workspace_access import current_workspace_scope
