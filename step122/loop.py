...
from step122.bus import MessageBus
from step122.bus.events import InboundMessage, OutboundMessage, StreamDeltaEvent
from step122.bus.outbound_events import (
    RetryWaitEvent,
...
from step122.bus.progress import build_bus_progress_callback
from step122.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step122.autocompact import AutoCompact
from step122.command import CommandContext, CommandRouter, register_builtin_commands
from step122.consolidation import Consolidator
from step122.context import ContextBuilder, RequestContext
from step122.goal_state import (
    goal_state_runtime_lines,
    runner_wall_llm_timeout_s,
    sustained_goal_active,
)
from step122.hook import (
    AgentHook,
    AgentHookContext,
...
from step122.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step122.model_runtime import ModelRuntimeResolver
from step122.memory import MemoryStore
from step122.pairing import PairingStore
from step122.runtime_context import (
...
from step122.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step122.security.workspace_access import WorkspaceScopeResolver
from step122.session import Session, SessionManager
from step122.session import turn_continuation
from step122.session.history_visibility import HIDDEN_HISTORY_META
from step122.session.keys import UNIFIED_SESSION_KEY
from step122.subagent import SubagentManager
from step122.tool import ToolRegistry
from step122.context import ToolContext
from step122.loader import ToolLoader
from step122.tools.file_state import FileStateStore
from step122.tools.exec_session import ExecSessionManager
from step122.tools.cli_apps import build_cli_app_manager
from step122.helpers import image_placeholder_text, truncate_text
from step122.utils.cancellation import task_is_cancelling
from step122.utils.document import reference_non_image_attachments
...
class AgentLoop:
    ...
    def __init__(
        ...
        # step122：CLI 应用白名单管理器（从 config.cli_apps.apps 注册，缺省空）
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step122.providers.factory import make_provider
    ...
    async def _state_build(self, ctx: TurnContext) -> str:
        ...
        from step122.session.manager import replay_max_messages_for_context
        ...
        from step122.tools.message import MessageTool
