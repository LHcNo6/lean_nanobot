...
class ModelPresetConfig(Base):
    ...
    def to_generation_settings(self) -> Any:
        from step122.llm import GenerationSettings
...
class ProvidersConfig(Base):
    ...
    def convert_extra_providers(self) -> "ProvidersConfig":
        ...
        from step122.providers.registry import find_by_name
...
class CliAppsConfig(Base):
    """cli_apps 配置段（step122，对齐 nanobot ``Config.cli_apps`` 最小形态）。"""
...
class Config(Base):
    ...
    cli_apps: CliAppsConfig = Field(default_factory=CliAppsConfig)  # step122
    ...
    def _match_provider(
        ...
        from step122.providers.registry import PROVIDERS, find_by_name, find_by_model
