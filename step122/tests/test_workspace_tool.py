...
from step122.context import ContextBuilder, ToolContext
...
from step122.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step122.session import Session, SessionManager
from step122.skills.loader import BUILTIN_SKILLS_DIR
from step122.tool import Tool, ToolRegistry, ToolResult
from step122.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step122.context import current_request_context
        from step122.security.workspace_access import current_workspace_scope
