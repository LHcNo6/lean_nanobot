...
from step122.tools.cli_apps import (
    CliApp,
    CliAppManager,
    CliAppsTool,
...
class TestBuildCliAppManager:
    """build_cli_app_manager 配置 -> 管理器（step122）。"""
    ...
    def test_registers_from_schema_config(self) -> None:
        ...
        from step122.config.schema import CliAppSpec, CliAppsConfig
...
class TestCliAppsToolRealExecution:
    """CliAppsTool 端到端真实执行（step122，已接线 manager）。"""
