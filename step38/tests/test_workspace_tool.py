...
from step38.bus.events import InboundMessage
from step38.context import ContextBuilder, ToolContext
from step38.llm import LLMResponse, ToolCallRequest
from step38.loop import AgentLoop
...
from step38.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step38.session import Session, SessionManager
from step38.skills.loader import BUILTIN_SKILLS_DIR
from step38.tool import Tool, ToolRegistry, ToolResult
from step38.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step38.context import current_request_context
        from step38.security.workspace_access import current_workspace_scope
