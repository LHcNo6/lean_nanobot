...
from step38.hook import AgentHook, AgentHookContext, AgentRunHookContext
from step38.llm import LLMResponse
from step38.provider import LLMProvider
from step38.tool import Tool, ToolRegistry
...
class AgentRunner:
    async def run(self, spec: AgentRunSpec) -> AgentRunResult:
        ...
        from step38.security.workspace_access import bind_workspace_scope, reset_workspace_scope
    ...
    def _append_injected_messages(
        ...
        from step38.session.history_visibility import is_hidden_history_message
