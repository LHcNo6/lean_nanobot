...
from step95.bus.events import InboundMessage
from step95.context import ContextBuilder, ToolContext
...
from step95.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step95.session import Session, SessionManager
from step95.skills.loader import BUILTIN_SKILLS_DIR
from step95.tool import Tool, ToolRegistry, ToolResult
from step95.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step95.context import current_request_context
        from step95.security.workspace_access import current_workspace_scope
