...
class ProvidersConfig(Base):
    ...
    def convert_extra_providers(self) -> "ProvidersConfig":
        ...
        from step71.providers.registry import find_by_name
...
class WebToolsConfig(Base):
    """Web 工具配置（step71：网页抓取基础版）。"""

    enable: bool = True
    timeout: int = 30
    user_agent: str = "Mozilla/5.0 (learn_nano)"  # 内置文件工具默认开启
...
class Config(Base):
    ...
    def _match_provider(
        ...
        from step71.providers.registry import PROVIDERS, find_by_name, find_by_model
