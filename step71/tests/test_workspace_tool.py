...
from step71.bus.events import InboundMessage
from step71.context import ContextBuilder, ToolContext
...
from step71.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step71.session import Session, SessionManager
from step71.skills.loader import BUILTIN_SKILLS_DIR
from step71.tool import Tool, ToolRegistry, ToolResult
from step71.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step71.context import current_request_context
        from step71.security.workspace_access import current_workspace_scope
