...
from step98.hook import AgentHook, AgentHookContext, AgentRunHookContext
from step98.llm import LLMResponse
...
class AgentRunner:
    ...
    async def run(self, spec: AgentRunSpec) -> AgentRunResult:
        ...
        from step98.security.workspace_access import bind_workspace_scope, reset_workspace_scope
        from step98.tools.file_state import FileStates, bind_file_states, reset_file_states
    ...
    def _append_injected_messages(
        ...
        from step98.session.history_visibility import is_hidden_history_message
