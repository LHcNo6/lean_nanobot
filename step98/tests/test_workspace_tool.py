...
from step98.bus.events import InboundMessage
from step98.context import ContextBuilder, ToolContext
...
from step98.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step98.session import Session, SessionManager
from step98.skills.loader import BUILTIN_SKILLS_DIR
from step98.tool import Tool, ToolRegistry, ToolResult
from step98.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step98.context import current_request_context
        from step98.security.workspace_access import current_workspace_scope
