...
from step110.bus.events import InboundMessage
from step110.context import ContextBuilder, ToolContext
...
from step110.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step110.session import Session, SessionManager
from step110.skills.loader import BUILTIN_SKILLS_DIR
from step110.tool import Tool, ToolRegistry, ToolResult
from step110.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step110.context import current_request_context
        from step110.security.workspace_access import current_workspace_scope
