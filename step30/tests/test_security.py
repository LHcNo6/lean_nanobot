...
from step30.security import network
from step30.security import workspace_policy as wp
...
from step30.security.workspace_policy import WorkspaceBoundaryError
