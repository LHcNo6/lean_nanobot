...
from step30.bus.events import InboundMessage
from step30.context import ContextBuilder, ToolContext
from step30.llm import LLMResponse, ToolCallRequest
from step30.loop import AgentLoop
...
from step30.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step30.session import Session, SessionManager
from step30.skills.loader import BUILTIN_SKILLS_DIR
from step30.tool import Tool, ToolRegistry, ToolResult
from step30.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step30.context import current_request_context
        from step30.security.workspace_access import current_workspace_scope
