...
from step30.bus.outbound_events import (
    RetryWaitEvent,
    StreamEndEvent,
    StreamedResponseEvent,
    outbound_message_for_event,
)
from step30.bus.progress import build_bus_progress_callback
from step30.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step30.autocompact import AutoCompact
from step30.command import CommandContext, CommandRouter, register_builtin_commands
from step30.consolidation import Consolidator
from step30.context import ContextBuilder, RequestContext
from step30.goal_state import goal_state_runtime_lines, sustained_goal_active
from step30.hook import (
    AgentHook,
    AgentHookContext,
    AgentTurnHookSpec,
    build_agent_turn_hook,
)
from step30.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step30.memory import MemoryStore
from step30.pairing import PairingStore
from step30.runtime_context import RuntimeContextBlock, resolve_runtime_context
from step30.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step30.security.workspace_access import WorkspaceScopeResolver
from step30.session import Session, SessionManager
from step30.session import turn_continuation
from step30.session.history_visibility import HIDDEN_HISTORY_META
from step30.session.keys import UNIFIED_SESSION_KEY
from step30.subagent import SubagentManager
from step30.tool import ToolRegistry
from step30.context import ToolContext
from step30.loader import ToolLoader
from step30.helpers import truncate_text
from step30.utils.cancellation import task_is_cancelling
...
class AgentLoop:
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step30.providers.factory import make_provider
    ...
    def _build_agent_spec(
        ...
        *,
        ...
        # step30：turn 级 hook 装配改用 build_agent_turn_hook（对齐 nanobot
        ...
        async def _publish_stream_end(*, resuming: bool = False, **_: Any) -> None:
            # step30：对齐 nanobot——关流语义走 typed ``StreamEndEvent``：
