...
from step64.bus.events import InboundMessage
from step64.context import ContextBuilder, ToolContext
...
from step64.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step64.session import Session, SessionManager
from step64.skills.loader import BUILTIN_SKILLS_DIR
from step64.tool import Tool, ToolRegistry, ToolResult
from step64.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        ...
        from step64.security.workspace_access import current_workspace_scope
