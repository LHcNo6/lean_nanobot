...
from step31.bus.events import InboundMessage
from step31.context import ContextBuilder, ToolContext
from step31.llm import LLMResponse, ToolCallRequest
from step31.loop import AgentLoop
...
from step31.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step31.session import Session, SessionManager
from step31.skills.loader import BUILTIN_SKILLS_DIR
from step31.tool import Tool, ToolRegistry, ToolResult
from step31.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step31.context import current_request_context
        from step31.security.workspace_access import current_workspace_scope
