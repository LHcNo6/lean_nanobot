...
from step31.bus.outbound_events import (
    RetryWaitEvent,
    StreamEndEvent,
    StreamedResponseEvent,
    outbound_message_for_event,
)
from step31.bus.progress import build_bus_progress_callback
from step31.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step31.autocompact import AutoCompact
from step31.command import CommandContext, CommandRouter, register_builtin_commands
from step31.consolidation import Consolidator
from step31.context import ContextBuilder, RequestContext
from step31.goal_state import goal_state_runtime_lines, sustained_goal_active
from step31.hook import (
    AgentHook,
    AgentHookContext,
    AgentTurnHookSpec,
    build_agent_turn_hook,
)
from step31.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step31.memory import MemoryStore
from step31.pairing import PairingStore
from step31.runtime_context import RuntimeContextBlock, resolve_runtime_context
from step31.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step31.security.workspace_access import WorkspaceScopeResolver
from step31.session import Session, SessionManager
from step31.session import turn_continuation
from step31.session.history_visibility import HIDDEN_HISTORY_META
from step31.session.keys import UNIFIED_SESSION_KEY
from step31.subagent import SubagentManager
from step31.tool import ToolRegistry
from step31.context import ToolContext
from step31.loader import ToolLoader
from step31.helpers import truncate_text
from step31.utils.cancellation import task_is_cancelling
...
class AgentLoop:
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step31.providers.factory import make_provider
    ...
    def _build_agent_spec(
        ...
        *,
        ...
        # step31：turn 级 hook 装配改用 build_agent_turn_hook（对齐 nanobot
        ...
        async def _publish_stream_end(*, resuming: bool = False, **_: Any) -> None:
            # step31：对齐 nanobot——关流语义走 typed ``StreamEndEvent``：
