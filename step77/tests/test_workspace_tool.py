...
from step77.context import ContextBuilder, ToolContext
...
from step77.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step77.session import Session, SessionManager
from step77.skills.loader import BUILTIN_SKILLS_DIR
from step77.tool import Tool, ToolRegistry, ToolResult
from step77.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step77.context import current_request_context
        from step77.security.workspace_access import current_workspace_scope
