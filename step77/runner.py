...
from step77.hook import AgentHook, AgentHookContext, AgentRunHookContext
from step77.llm import LLMResponse
from step77.provider import LLMProvider
from step77.tool import Tool, ToolRegistry, ToolResult
...
class AgentRunner:
    ...
    async def run(self, spec: AgentRunSpec) -> AgentRunResult:
        ...
        from step77.security.workspace_access import bind_workspace_scope, reset_workspace_scope
        from step77.tools.file_state import FileStates, bind_file_states, reset_file_states
    ...
    def _append_injected_messages(
        ...
        from step77.session.history_visibility import is_hidden_history_message
