...
from step77.bus.events import InboundMessage, OutboundMessage, StreamDeltaEvent
from step77.bus.outbound_events import (
    RetryWaitEvent,
...
from step77.bus.progress import build_bus_progress_callback
from step77.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step77.autocompact import AutoCompact
from step77.command import CommandContext, CommandRouter, register_builtin_commands
from step77.consolidation import Consolidator
from step77.context import ContextBuilder, RequestContext
from step77.goal_state import (
    goal_state_runtime_lines,
    runner_wall_llm_timeout_s,
    sustained_goal_active,
)
from step77.hook import (
    AgentHook,
    AgentHookContext,
...
from step77.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step77.model_runtime import ModelRuntimeResolver
from step77.memory import MemoryStore
from step77.pairing import PairingStore
...
from step77.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step77.security.workspace_access import WorkspaceScopeResolver
from step77.session import Session, SessionManager
from step77.session import turn_continuation
from step77.session.history_visibility import HIDDEN_HISTORY_META
from step77.session.keys import UNIFIED_SESSION_KEY
from step77.subagent import SubagentManager
from step77.tool import ToolRegistry
from step77.context import ToolContext
from step77.loader import ToolLoader
from step77.tools.file_state import FileStateStore
from step77.tools.exec_session import ExecSessionManager
from step77.helpers import image_placeholder_text, truncate_text
from step77.utils.cancellation import task_is_cancelling
from step77.utils.document import reference_non_image_attachments
...
class AgentLoop:
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step77.providers.factory import make_provider
    ...
    async def _state_build(self, ctx: TurnContext) -> str:
        ...
        from step77.session.manager import replay_max_messages_for_context
        ...
        from step77.tools.message import MessageTool
