...
from step48.bus.events import InboundMessage
from step48.context import ContextBuilder, ToolContext
from step48.llm import LLMResponse, ToolCallRequest
from step48.loop import AgentLoop
from step48.memory import MemoryStore
from step48.provider import LLMProvider
from step48.runner import AgentRunSpec, AgentRunner
from step48.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step48.session import Session, SessionManager
from step48.skills.loader import BUILTIN_SKILLS_DIR
from step48.tool import Tool, ToolRegistry, ToolResult
from step48.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step48.context import current_request_context
        from step48.security.workspace_access import current_workspace_scope
