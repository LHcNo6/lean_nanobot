...
from step68.bus.events import InboundMessage
from step68.context import ContextBuilder, ToolContext
...
from step68.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step68.session import Session, SessionManager
from step68.skills.loader import BUILTIN_SKILLS_DIR
from step68.tool import Tool, ToolRegistry, ToolResult
from step68.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step68.context import current_request_context
        from step68.security.workspace_access import current_workspace_scope
