...
from step33.bus.events import InboundMessage
from step33.context import ContextBuilder, ToolContext
from step33.llm import LLMResponse, ToolCallRequest
from step33.loop import AgentLoop
...
from step33.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step33.session import Session, SessionManager
from step33.skills.loader import BUILTIN_SKILLS_DIR
from step33.tool import Tool, ToolRegistry, ToolResult
from step33.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step33.context import current_request_context
        from step33.security.workspace_access import current_workspace_scope
