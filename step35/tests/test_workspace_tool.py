...
from step35.bus.events import InboundMessage
from step35.context import ContextBuilder, ToolContext
from step35.llm import LLMResponse, ToolCallRequest
from step35.loop import AgentLoop
...
from step35.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step35.session import Session, SessionManager
from step35.skills.loader import BUILTIN_SKILLS_DIR
from step35.tool import Tool, ToolRegistry, ToolResult
from step35.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step35.context import current_request_context
        from step35.security.workspace_access import current_workspace_scope
