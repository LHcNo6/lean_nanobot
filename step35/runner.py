...
from step35.hook import AgentHook, AgentHookContext, AgentRunHookContext
from step35.llm import LLMResponse
from step35.provider import LLMProvider
from step35.tool import Tool, ToolRegistry
...
class AgentRunner:
    async def run(self, spec: AgentRunSpec) -> AgentRunResult:
        ...
        from step35.security.workspace_access import bind_workspace_scope, reset_workspace_scope
    ...
    def _append_injected_messages(
        ...
        from step35.session.history_visibility import is_hidden_history_message
