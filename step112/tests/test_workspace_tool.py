...
from step112.bus.events import InboundMessage
from step112.context import ContextBuilder, ToolContext
...
from step112.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step112.session import Session, SessionManager
from step112.skills.loader import BUILTIN_SKILLS_DIR
from step112.tool import Tool, ToolRegistry, ToolResult
from step112.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step112.context import current_request_context
        from step112.security.workspace_access import current_workspace_scope
