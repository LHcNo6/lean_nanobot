...
from step112.hook import AgentHook, AgentHookContext
...
class SubagentManager:
    ...
    step112 起不再复用主 agent 的工具注册表，而是通过 ``_build_tools()``
    ...
    def __init__(
        ...
        *,
        ...
        # step112：manager 自己持有的长命令会话管理器，跨子代理共享
    ...
    async def _run_subagent(self, task_id: str, task: str, label: str, origin: dict, status: SubagentStatus) -> None:
        ...
        step112：工具集改为每次 spawn 时经 ``_build_tools()`` 新建 ——
