...
from step43.context import ContextBuilder, ToolContext
...
from step43.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step43.session import Session, SessionManager
from step43.skills.loader import BUILTIN_SKILLS_DIR
from step43.tool import Tool, ToolRegistry, ToolResult
from step43.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step43.context import current_request_context
        from step43.security.workspace_access import current_workspace_scope
