...
from step43.hook import AgentHook, AgentHookContext, AgentRunHookContext
from step43.llm import LLMResponse
from step43.provider import LLMProvider
from step43.tool import Tool, ToolRegistry
...
class AgentRunner:
    async def run(self, spec: AgentRunSpec) -> AgentRunResult:
        ...
        from step43.security.workspace_access import bind_workspace_scope, reset_workspace_scope
        from step43.tools.file_state import FileStates, bind_file_states, reset_file_states
    ...
    def _append_injected_messages(
        ...
        from step43.session.history_visibility import is_hidden_history_message
