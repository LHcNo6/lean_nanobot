...
from step52.bus.events import InboundMessage
from step52.context import ContextBuilder, ToolContext
from step52.llm import LLMResponse, ToolCallRequest
from step52.loop import AgentLoop
from step52.memory import MemoryStore
from step52.provider import LLMProvider
from step52.runner import AgentRunSpec, AgentRunner
from step52.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step52.session import Session, SessionManager
from step52.skills.loader import BUILTIN_SKILLS_DIR
from step52.tool import Tool, ToolRegistry, ToolResult
from step52.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step52.context import current_request_context
        from step52.security.workspace_access import current_workspace_scope
