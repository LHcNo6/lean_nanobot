...
from step92.bus.events import InboundMessage
from step92.context import ContextBuilder, ToolContext
...
from step92.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step92.session import Session, SessionManager
from step92.skills.loader import BUILTIN_SKILLS_DIR
from step92.tool import Tool, ToolRegistry, ToolResult
from step92.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step92.context import current_request_context
        from step92.security.workspace_access import current_workspace_scope
