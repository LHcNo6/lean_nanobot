...
from step28.hook import AgentHook, AgentHookContext, AgentRunHookContext
from step28.llm import LLMResponse
from step28.provider import LLMProvider
from step28.tool import Tool, ToolRegistry
...
@dataclass
class AgentRunSpec:
    """一次 agent 运行的完整参数（step28 起新增 request_context / workspace_scope）。
...
class AgentRunner:
    async def run(self, spec: AgentRunSpec) -> AgentRunResult:
        ...
        from step28.security.workspace_access import bind_workspace_scope, reset_workspace_scope
        ...
        # step28：优先绑定调用方（loop/subagent）提供的富 RequestContext，
        ...
        # step28：本 turn 的 workspace scope 一并绑定，工具内可通过
