...
from step28.schema import StringSchema, IntegerSchema, tool_parameters_schema
from step28.security.workspace_access import current_tool_workspace
from step28.security.workspace_policy import WorkspaceBoundaryError, resolve_allowed_path
from step28.skills.loader import BUILTIN_SKILLS_DIR
from step28.tool import Tool, ToolResult, tool_parameters
...
class ReadFileTool(Tool):
    ...
    def create(cls, ctx: Any) -> Tool:
        # step28: 工具从 ToolContext 拿到真实 workspace 与权限意图
