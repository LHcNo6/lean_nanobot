...
from step28.bus.events import OutboundMessage, StreamDeltaEvent
...
from step28.channels.registry import (
    ...
    def _init_channels(self) -> None:
        ...
        for name in sorted(candidates):
            ...
            if name not in names:
                print(f"[manager] Channel '{name}' not found in step28.channels, skipping")
                continue
            try:
