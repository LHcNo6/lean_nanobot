"""Step28 workspace 工具端测试（A10 消费端 + runner 绑定）。
...
from step28.bus.events import InboundMessage
from step28.context import ContextBuilder, ToolContext
from step28.llm import LLMResponse, ToolCallRequest
from step28.loop import AgentLoop
...
from step28.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step28.session import Session, SessionManager
from step28.skills.loader import BUILTIN_SKILLS_DIR
from step28.tool import Tool, ToolRegistry, ToolResult
from step28.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step28.context import current_request_context
        from step28.security.workspace_access import current_workspace_scope
