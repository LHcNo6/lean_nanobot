...
from step28.bus.outbound_events import (
    RetryWaitEvent,
    StreamedResponseEvent,
    outbound_message_for_event,
)
from step28.bus.progress import build_bus_progress_callback
from step28.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step28.autocompact import AutoCompact
from step28.command import CommandContext, CommandRouter, register_builtin_commands
from step28.consolidation import Consolidator
from step28.context import ContextBuilder, RequestContext
from step28.goal_state import goal_state_runtime_lines, sustained_goal_active
from step28.hook import AgentHook, AgentHookContext, CompositeHook
from step28.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step28.memory import MemoryStore
from step28.pairing import PairingStore
from step28.runtime_context import RuntimeContextBlock, resolve_runtime_context
from step28.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step28.security.workspace_access import WorkspaceScopeResolver
from step28.session import Session, SessionManager
from step28.subagent import SubagentManager
from step28.tool import ToolRegistry
...
@dataclass
class TurnContext:
    """一次 turn 的状态载体（step28 起新增 request_context / runtime_context_blocks）。"""
...
class AgentLoop:
    ...
    def __init__(
        ...
        # step28: workspace 权限范围解析器（默认根 = context_builder.workspace）。
        self.restrict_to_workspace = restrict_to_workspace
        self.workspace_scopes = WorkspaceScopeResolver(
            default_workspace=context_builder.workspace,
            default_restrict_to_workspace=restrict_to_workspace,
        )
        # step28: 每 turn 前解析一次的运行时上下文提供器（loop 级注册）。
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step28.providers.factory import make_provider
        ...
        return cls(
            ...
            config=config,
            # step28: 权限意图贯通 —— config.tools.restrict_to_workspace 驱动
    ...
    async def _state_build(self, ctx: TurnContext) -> str:
        ...
        if goal_lines:
            identity = identity + "\n\n" + "\n".join(goal_lines)
        # step28: 解析本 turn 的运行时上下文（工具/loop provider）并随
    ...
    async def _process_system_message(
        ...
        *,
        ...
        # step28: 系统通道同样解析运行时上下文（provider 可依据
    ...
    async def _state_run(self, ctx: TurnContext) -> str:
        ...
        await self._runtime_events().run_status_changed(
            ctx.msg, session_key, "running", started_at=started_at,
        )
