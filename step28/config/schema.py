...
class ProvidersConfig(Base):
    ...
    def convert_extra_providers(self) -> "ProvidersConfig":
        ...
        from step28.providers.registry import find_by_name
...
class ToolsConfig(Base):
    ...
    Attributes:
        restrict_to_workspace: 权限意图 —— 默认限制工具文件访问在 workspace 内
            （对齐 nanobot `tools.restrict_to_workspace`，step28 起生效）。
    """
...
class Config(Base):
    ...
    def _match_provider(
        ...
        from step28.providers.registry import PROVIDERS, find_by_name, find_by_model
