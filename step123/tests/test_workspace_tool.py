...
from step123.context import ContextBuilder, ToolContext
...
from step123.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step123.session import Session, SessionManager
from step123.skills.loader import BUILTIN_SKILLS_DIR
from step123.tool import Tool, ToolRegistry, ToolResult
from step123.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step123.context import current_request_context
        from step123.security.workspace_access import current_workspace_scope
