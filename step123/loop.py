...
from step123.bus.events import InboundMessage, OutboundMessage, StreamDeltaEvent
from step123.bus.outbound_events import (
    RetryWaitEvent,
...
from step123.bus.progress import build_bus_progress_callback
from step123.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step123.autocompact import AutoCompact
from step123.command import CommandContext, CommandRouter, register_builtin_commands
from step123.consolidation import Consolidator
from step123.context import ContextBuilder, RequestContext
from step123.goal_state import (
    goal_state_runtime_lines,
    runner_wall_llm_timeout_s,
    sustained_goal_active,
)
from step123.hook import (
    AgentHook,
    AgentHookContext,
...
from step123.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step123.model_runtime import ModelRuntimeResolver
from step123.memory import MemoryStore
from step123.pairing import PairingStore
from step123.runtime_context import (
...
from step123.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step123.security.workspace_access import WorkspaceScopeResolver
from step123.session import Session, SessionManager
from step123.session import turn_continuation
from step123.session.history_visibility import HIDDEN_HISTORY_META
from step123.session.keys import UNIFIED_SESSION_KEY
from step123.subagent import SubagentManager
from step123.tool import ToolRegistry
from step123.context import ToolContext
from step123.loader import ToolLoader
from step123.tools.file_state import FileStateStore
from step123.tools.exec_session import ExecSessionManager
from step123.tools.cli_apps import build_cli_app_manager
from step123.helpers import image_placeholder_text, truncate_text
from step123.utils.cancellation import task_is_cancelling
from step123.utils.document import reference_non_image_attachments
...
class AgentLoop:
    ...
    def __init__(
        ...
        # step123：CLI 应用白名单管理器（从 config.cli_apps.apps 注册，缺省空）
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step123.providers.factory import make_provider
    ...
    async def _state_build(self, ctx: TurnContext) -> str:
        ...
        from step123.session.manager import replay_max_messages_for_context
        ...
        from step123.tools.message import MessageTool
