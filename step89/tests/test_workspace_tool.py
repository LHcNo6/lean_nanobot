...
from step89.bus.events import InboundMessage
from step89.context import ContextBuilder, ToolContext
...
from step89.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step89.session import Session, SessionManager
from step89.skills.loader import BUILTIN_SKILLS_DIR
from step89.tool import Tool, ToolRegistry, ToolResult
from step89.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step89.context import current_request_context
        from step89.security.workspace_access import current_workspace_scope
