...
from step81.bus.events import InboundMessage
from step81.context import ContextBuilder, ToolContext
...
from step81.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step81.session import Session, SessionManager
from step81.skills.loader import BUILTIN_SKILLS_DIR
from step81.tool import Tool, ToolRegistry, ToolResult
from step81.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step81.context import current_request_context
        from step81.security.workspace_access import current_workspace_scope
