...
from step67.bus.events import InboundMessage
from step67.context import ContextBuilder, ToolContext
...
from step67.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step67.session import Session, SessionManager
from step67.skills.loader import BUILTIN_SKILLS_DIR
from step67.tool import Tool, ToolRegistry, ToolResult
from step67.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step67.context import current_request_context
        from step67.security.workspace_access import current_workspace_scope
