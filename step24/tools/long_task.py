...
from step24.goal_state import GOAL_STATE_KEY, MAX_GOAL_OBJECTIVE_CHARS, parse_goal_state
from step24.schema import StringSchema, tool_parameters_schema
from step24.tool import Tool, ToolResult, tool_parameters
...
class CreateGoalTool(Tool):
    ...
    async def execute(self, objective: str = "", ui_summary: str | None = None, **kwargs: Any) -> ToolResult:
        from step24.context import current_request_context
