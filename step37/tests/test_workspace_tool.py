...
from step37.bus.events import InboundMessage
from step37.context import ContextBuilder, ToolContext
from step37.llm import LLMResponse, ToolCallRequest
from step37.loop import AgentLoop
...
from step37.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step37.session import Session, SessionManager
from step37.skills.loader import BUILTIN_SKILLS_DIR
from step37.tool import Tool, ToolRegistry, ToolResult
from step37.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step37.context import current_request_context
        from step37.security.workspace_access import current_workspace_scope
