...
from step37.memory import MemoryStore, _ARCHIVE_SUMMARY_MAX_CHARS, _RAW_ARCHIVE_MAX_CHARS
...
class Consolidator:
    ...
    async def archive(self, messages: list[dict[str, Any]], *, runtime: Runtime, session_key: str | None = None, summary_messages: list[dict[str, Any]] | None = None) -> str | None:
        ...
        from step37.runtime_context import public_history_messages
