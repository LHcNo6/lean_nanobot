...
from step37.config import load_config, resolve_config_env_vars
from step37.context import ContextBuilder
from step37.llm import LLMRuntime
...
from step37.providers.factory import build_provider_snapshot
from step37.session import SessionManager
...
async def main():
    ...
    async def _clock_runtime_context(request_context: Any):
        from step37.runtime_context import RuntimeContextBlock, wrap_runtime_context_lines
