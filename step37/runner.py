...
from step37.hook import AgentHook, AgentHookContext, AgentRunHookContext
from step37.llm import LLMResponse
from step37.provider import LLMProvider
from step37.tool import Tool, ToolRegistry
...
class AgentRunner:
    async def run(self, spec: AgentRunSpec) -> AgentRunResult:
        ...
        from step37.security.workspace_access import bind_workspace_scope, reset_workspace_scope
    ...
    def _append_injected_messages(
        ...
        from step37.session.history_visibility import is_hidden_history_message
