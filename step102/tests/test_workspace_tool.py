...
from step102.bus.events import InboundMessage
from step102.context import ContextBuilder, ToolContext
...
from step102.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step102.session import Session, SessionManager
from step102.skills.loader import BUILTIN_SKILLS_DIR
from step102.tool import Tool, ToolRegistry, ToolResult
from step102.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step102.context import current_request_context
        from step102.security.workspace_access import current_workspace_scope
