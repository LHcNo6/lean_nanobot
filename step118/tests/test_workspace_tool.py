...
from step118.context import ContextBuilder, ToolContext
...
from step118.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step118.session import Session, SessionManager
from step118.skills.loader import BUILTIN_SKILLS_DIR
from step118.tool import Tool, ToolRegistry, ToolResult
from step118.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step118.context import current_request_context
        from step118.security.workspace_access import current_workspace_scope
