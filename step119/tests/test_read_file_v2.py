...
from step119.tool import ToolRegistry, ToolResult
from step119.tools.filesystem import ReadFileTool
...
class TestReadFileDiscovery:
    ...
    def test_reexport_compatible(self) -> None:
        """旧导入路径仍可用（re-export）。"""
        from step119.tools.read_file import ReadFileTool as OldReadFileTool
        from step119.tools.filesystem import ReadFileTool as NewReadFileTool
