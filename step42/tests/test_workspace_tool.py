...
from step42.bus.events import InboundMessage
from step42.context import ContextBuilder, ToolContext
...
from step42.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step42.session import Session, SessionManager
from step42.skills.loader import BUILTIN_SKILLS_DIR
from step42.tool import Tool, ToolRegistry, ToolResult
from step42.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        ...
        from step42.security.workspace_access import current_workspace_scope
