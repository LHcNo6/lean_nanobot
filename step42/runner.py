...
from step42.hook import AgentHook, AgentHookContext, AgentRunHookContext
from step42.llm import LLMResponse
from step42.provider import LLMProvider
from step42.tool import Tool, ToolRegistry
...
class AgentRunner:
    async def run(self, spec: AgentRunSpec) -> AgentRunResult:
        ...
        from step42.security.workspace_access import bind_workspace_scope, reset_workspace_scope
        from step42.tools.file_state import FileStates, bind_file_states, reset_file_states
    ...
    def _append_injected_messages(
        ...
        from step42.session.history_visibility import is_hidden_history_message
