...
from step26.config import load_config, resolve_config_env_vars
from step26.context import ContextBuilder
from step26.llm import LLMRuntime
from step26.loop import AgentLoop
from step26.manager import ChannelManager
from step26.memory import MemoryStore
from step26.pairing import PairingStore
from step26.providers.factory import build_provider_snapshot
from step26.session import SessionManager
...
async def main():
    ...
    # step26 (H3 起步): 装配 harness 在 from_config 之上挂载运行时事件订阅。
