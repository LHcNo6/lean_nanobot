...
- **Config 路径（新，step26）**：`make_provider(config, preset_name=...)` —— 从
...
from step26.llm import GenerationSettings
...
from step26.providers.registry import (
    PROVIDERS,
    ProviderSpec,
    create_dynamic_spec,
    find_by_model,
...
def is_config_input(obj: Any) -> bool:
    ...
    from step26.config.schema import Config
...
# ===========================================================================
# 新路径：Config 驱动（step26，对齐 nanobot factory）
# ===========================================================================
