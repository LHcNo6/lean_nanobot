...
from step26.bus.events import OutboundMessage
from step26.bus.outbound_events import ProgressEvent, RetryWaitEvent
...
class CliChannel(BaseChannel):
    ...
    async def send(self, msg: OutboundMessage) -> None:
        # step26: typed 运行时事件（进度/重试等待）不是最终回复——只作状态行
