...
from step96.hook import AgentHook, AgentHookContext, AgentRunHookContext
from step96.llm import LLMResponse
from step96.provider import LLMProvider
from step96.tool import Tool, ToolRegistry, ToolResult
...
class AgentRunner:
    ...
    async def run(self, spec: AgentRunSpec) -> AgentRunResult:
        ...
        from step96.security.workspace_access import bind_workspace_scope, reset_workspace_scope
        from step96.tools.file_state import FileStates, bind_file_states, reset_file_states
    ...
    def _append_injected_messages(
        ...
        from step96.session.history_visibility import is_hidden_history_message
