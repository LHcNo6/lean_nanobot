...
class ToolContext:
    ...
    agent_loop: Any = None  # step96：AgentLoop 引用（MyTool 自省）
...
class ContextBuilder:
    ...
    def skills(self) -> Any:
        ...
        if self._skills is None:
            from step96.skills import SkillsLoader
    ...
    def build_system_prompt(
        ...
        step96：该参数不再是 no-op，为 True 时注入 MEMORY.md 长期记忆。
        ...
        # step96：长期记忆注入（MEMORY.md），对齐 nanobot get_memory_context()
