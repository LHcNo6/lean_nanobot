...
from step96.context import ContextBuilder, ToolContext
...
from step96.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step96.session import Session, SessionManager
from step96.skills.loader import BUILTIN_SKILLS_DIR
from step96.tool import Tool, ToolRegistry, ToolResult
from step96.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step96.context import current_request_context
        from step96.security.workspace_access import current_workspace_scope
