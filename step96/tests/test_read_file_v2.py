...
from step96.tool import ToolRegistry, ToolResult
from step96.tools.filesystem import ReadFileTool
...
class TestReadFileDiscovery:
    ...
    def test_reexport_compatible(self) -> None:
        """旧导入路径仍可用（re-export）。"""
        from step96.tools.read_file import ReadFileTool as OldReadFileTool
        from step96.tools.filesystem import ReadFileTool as NewReadFileTool
