...
from step96.autocompact import AutoCompact
from step96.command import CommandContext, CommandRouter, register_builtin_commands
from step96.consolidation import Consolidator
from step96.context import ContextBuilder, RequestContext
from step96.goal_state import (
    goal_state_runtime_lines,
    runner_wall_llm_timeout_s,
    sustained_goal_active,
)
from step96.hook import (
    AgentHook,
    AgentHookContext,
...
from step96.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step96.model_runtime import ModelRuntimeResolver
from step96.memory import MemoryStore
from step96.pairing import PairingStore
from step96.runtime_context import (
...
from step96.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step96.security.workspace_access import WorkspaceScopeResolver
from step96.session import Session, SessionManager
from step96.session import turn_continuation
from step96.session.history_visibility import HIDDEN_HISTORY_META
from step96.session.keys import UNIFIED_SESSION_KEY
from step96.subagent import SubagentManager
from step96.tool import ToolRegistry
from step96.context import ToolContext
from step96.loader import ToolLoader
from step96.tools.file_state import FileStateStore
from step96.tools.exec_session import ExecSessionManager
from step96.helpers import image_placeholder_text, truncate_text
from step96.utils.cancellation import task_is_cancelling
from step96.utils.document import reference_non_image_attachments
...
class AgentLoop:
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step96.providers.factory import make_provider
    ...
    async def _state_build(self, ctx: TurnContext) -> str:
        ...
        from step96.session.manager import replay_max_messages_for_context
        ...
        from step96.tools.message import MessageTool
