...
from step61.bus.events import InboundMessage
from step61.context import ContextBuilder, ToolContext
...
from step61.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step61.session import Session, SessionManager
from step61.skills.loader import BUILTIN_SKILLS_DIR
from step61.tool import Tool, ToolRegistry, ToolResult
from step61.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step61.context import current_request_context
        from step61.security.workspace_access import current_workspace_scope
