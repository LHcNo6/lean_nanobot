...
from step61.helpers import find_legal_message_start, recent_message_start_index
...
class TestReplayMaxMessagesForContext:
    def test_none_returns_file_max(self):
        from step61.session.manager import FILE_MAX_MESSAGES, replay_max_messages_for_context
    ...
    def test_small_context_uses_min(self):
        from step61.session.manager import MIN_REPLAY_MAX_MESSAGES, replay_max_messages_for_context
