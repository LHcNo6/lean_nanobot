...
def _json_default(obj: Any) -> Any:
    """JSON 序列化默认处理：datetime 转为 ISO 字符串（step61）。"""
...
class Session:
    ...
    def get_history(
        ...
        *,
        ...
        """
        from step61.helpers import estimate_message_tokens
        from step61.runtime_context import RUNTIME_CONTEXT_HISTORY_META, public_history_message
