...
from step108.bus.events import InboundMessage
from step108.context import ContextBuilder, ToolContext
...
from step108.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step108.session import Session, SessionManager
from step108.skills.loader import BUILTIN_SKILLS_DIR
from step108.tool import Tool, ToolRegistry, ToolResult
from step108.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step108.context import current_request_context
        from step108.security.workspace_access import current_workspace_scope
