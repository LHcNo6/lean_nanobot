...
- **Config 路径（新，step25）**：`make_provider(config, preset_name=...)` —— 从
...
from step25.llm import GenerationSettings
from step25.openai_compat_provider import OpenAICompatProvider
from step25.providers.fallback_provider import FallbackProvider
from step25.providers.registry import (
    PROVIDERS,
    ProviderSpec,
    create_dynamic_spec,
    find_by_model,
...
def is_config_input(obj: Any) -> bool:
    ...
    from step25.config.schema import Config
...
# ===========================================================================
# 新路径：Config 驱动（step25，对齐 nanobot factory）
# ===========================================================================
