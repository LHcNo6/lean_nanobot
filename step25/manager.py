...
from step25.channels.registry import (
    DEFAULT_ENABLED_CHANNELS,
    discover_channel_names,
    load_channel_class,
)
from step25.events import OutboundMessage, StreamDeltaEvent
    ...
    def _init_channels(self) -> None:
        ...
        for name in sorted(candidates):
            ...
            if name not in names:
                print(f"[manager] Channel '{name}' not found in step25.channels, skipping")
                continue
            try:
