...
from step29.bus.outbound_events import (
    RetryWaitEvent,
    StreamedResponseEvent,
    outbound_message_for_event,
)
from step29.bus.progress import build_bus_progress_callback
from step29.bus.runtime_events import (
    RuntimeEventBus,
    RuntimeEventPublisher,
)
from step29.autocompact import AutoCompact
from step29.command import CommandContext, CommandRouter, register_builtin_commands
from step29.consolidation import Consolidator
from step29.context import ContextBuilder, RequestContext
from step29.goal_state import goal_state_runtime_lines, sustained_goal_active
from step29.hook import AgentHook, AgentHookContext, CompositeHook
from step29.llm import LLMResponse, LLMRuntime, ToolCallRequest
from step29.memory import MemoryStore
from step29.pairing import PairingStore
from step29.runtime_context import RuntimeContextBlock, resolve_runtime_context
from step29.runner import (
    AgentRunResult,
    AgentRunSpec,
    AgentRunner,
    _MAX_INJECTIONS_PER_TURN,
)
from step29.security.workspace_access import WorkspaceScopeResolver
from step29.session import Session, SessionManager
from step29.session import turn_continuation
from step29.session.history_visibility import HIDDEN_HISTORY_META
from step29.session.keys import UNIFIED_SESSION_KEY
from step29.subagent import SubagentManager
from step29.tool import ToolRegistry
from step29.context import ToolContext
from step29.loader import ToolLoader
from step29.helpers import truncate_text
from step29.utils.cancellation import task_is_cancelling
...
class AgentLoop:
    ...
    def from_config(
        ...
        **extra: Any,
        ...
        """
        from step29.providers.factory import make_provider
