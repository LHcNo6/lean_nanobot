...
from step29.bus.events import InboundMessage
from step29.context import ContextBuilder, ToolContext
from step29.llm import LLMResponse, ToolCallRequest
from step29.loop import AgentLoop
...
from step29.security.workspace_access import (
    current_tool_workspace,
    current_workspace_scope,
    default_workspace_scope,
)
from step29.session import Session, SessionManager
from step29.skills.loader import BUILTIN_SKILLS_DIR
from step29.tool import Tool, ToolRegistry, ToolResult
from step29.tools.read_file import ReadFileTool
...
class _ProbeTool(Tool):
    ...
    async def execute(self, text: str = "", **kwargs) -> ToolResult:
        from step29.context import current_request_context
        from step29.security.workspace_access import current_workspace_scope
